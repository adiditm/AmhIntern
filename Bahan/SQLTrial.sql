...
select * from tb_komisi

DELETE FROM tb_withdraw WHERE fidsys >= '594';
select b.fsaldovcr from m_korwil a left join m_pebisnis b on b.fidmember=a.fidbisnis  where a.fidkorwil='SDA01'


        
 select b.fsaldovcr from m_korwil a left join m_pebisnis b on b.fidmember=a.fidbisnis  where a.fidkorwil='SDA01' 
 
 select a.fidbisnis from m_korwil a left join m_pebisnis b on b.fidmember=a.fidbisnis  where a.fidkorwil='SDA01' 
 
 
 update m_admin set fpassword=md5('123456') where fidmember='1412-0000-0014'
 
 select * from m_korwil where fidbisnis='1412-0000-0014'
