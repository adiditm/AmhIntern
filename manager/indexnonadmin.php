  ...
  <div class="row states-info">
    ...
    <div class="col-md-12">
     ...
     <div class="row">
            ...
            <div class="col-xs-8" align="">
              
             
              
              <h2 style="font-size:24px"> Selamat Datang <?=ucwords(strtolower($vNama))?></h2>
              
              <br>
              <span style="color:#FF0;font-weight:bold;font-size:15px">Masa berlaku keanggotaan  s/d <?
