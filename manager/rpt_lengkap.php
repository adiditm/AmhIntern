...
if ($vFBring=='0') 
     $vAnd .= " and fidmember not in(select fidmember from m_anggota where faktif='1'  $vAndBring )  ";	

if ($vFDoc=='1') 
     $vAnd .= $vAndDoc ;	

if ($vFDoc=='0') 
     $vAnd .= " and fidmember not in(select fidmember from m_anggota where faktif='1' $vAndDoc )  ";		
...
<div class="row">
		<div><label>
		<h3>Laporan Kelengkapan</h3></label></div>  		       
...
<div class="col-lg-12"  >
      ...
      <form name="demoform"  method="post" id="demoform" style="color:black" >
        <div class="row"> 
              ...
              <div class="col-lg-2">
               <input autocomplete="false" name="tfFMonth" id="tfFMonth" type="text" class="form-control"  value="<?=$vFMonth?>"/>
          		</div>
              ...
              <div class="col-lg-2">
               <input autocomplete="false" name="tfFDepart" id="tfFDepart" type="text" class="form-control" value="<?=$vFDepart?>" />
          </div>
 ...
 <div class="row"> 
              ...
              <div class="col-lg-2">
               <select name="tfFDoc" id="tfFDoc" class="form-control">
              ...
              <div class="col-lg-2">
               <select name="tfFBring" id="tfFBring" class="form-control">
...
<tr style="font-weight:bold">
  ...
  <td align="center"  >Sex<br />
    M/F</td>
  <td  width="150" align="center">Alamat</td>
  <td  width="150" align="center">Phone/HP</td>
  <td  width="150" align="center">Tgl. Daftar</td>
  <td  width="150" align="center">Tgl. Berangkat</td>
  <td  width="150" align="center">Kelengkapan Doc</td>
  <td  width="150" align="center">Kelengkapan Bawaan</td>
  </tr>
</thead>
  <tbody>      
        <?
			 ...
			 while($db->next_record()) {
				 ...
				 $vHP = $db->f('fnohp');
				 $vTglDaftar = $db->f('ftgldaftar');
				 $vTglBerangkat = $db->f('ftgldepart');
        ...
        <tr style="color:<?=$vColor?>"><td style="text-align: right;vertical-align:middle" valign="middle" ><?=$vCount?></td>
          <td valign="middle" style="vertical-align:middle"><?=strtoupper($vNama)?>
          <input type="hidden" id="<?=$vIDHDoc?>" value='<?=$vDoc?>' >
           <input type="hidden" id="<?=$vIDHBring?>" value='<?=$vBring?>' >
          </td>
          <td align="center" valign="middle" style="vertical-align:middle"><?=$vSex?></td>
          <td align="left" valign="middle" style="vertical-align:middle"><?=$vAlamat?></td>
          <td align="center" valign="middle" style="vertical-align:middle"><?=$vHP?>;</td>
          <td align="center" valign="middle" style="vertical-align:middle"><?=$oPhpdate->YMD2DMY($vTglDaftar)?></td>
          <td align="center" valign="middle" style="vertical-align:middle"><?=$oPhpdate->YMD2DMY($vTglBerangkat)?></td>
          <td align="center" valign="middle" style="vertical-align:middle"><a class="btn <?=$vClass?>" href="#" onclick="showDoc(document.getElementById('<?=$vIDHDoc?>').value,'<?=strtoupper($vNama)?>');"><?=$vDocLengkap;?></a></td>
          <td align="center" valign="middle" style="vertical-align:middle"><a class="btn <?=$vClass?>" href="#" onclick="showBring(document.getElementById('<?=$vIDHBring?>').value,'<?=strtoupper($vNama)?>','<?=$vSex?>');"><?=$vBringLengkap?></a></td>
          </tr>
        <? } } ?>
