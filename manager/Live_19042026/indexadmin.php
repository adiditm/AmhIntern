        ...
        <div class="panel-body">
          ...
          <div class="row">
            ...
            <div class="col-xs-8">
              ...
              <b><span class="state-title">Transaksi Produk Pending  </span></b>
        ...
        <div class="panel-body">
          ...
          <div class="row">
            ...
            <div class="col-xs-8">
              ...
              <b><span class="state-title">Transaksi Produk Sukses  </span></b>
...
<? if ($vScriptName!='appvtrans.php') { 

				$vsql ="select distinct ftglupdate, fidtrans,fidmember, fket,fstatusrow, fnominal from tb_baltrans where    fstatusrow='0' ";
...
Lobibox.notify('warning',  // Available types 'warning', 'info', 'success', 'error'
{
   closeOnEsc      : true,
   draggable       : true, 
   msg					:'Approval <font color="#0f0">transfer</font> <?=$vIDMember?> / <?=$vNama?> ! Klik <a style="color:blue" href="../manager/appvtrans.php?op=&current=mdm_admin&menu=mdm_admin_veriwith">di sini</a> utk memproses. ',
   delay: false,
   closeOnClick : false,
   size : 'mini' 
