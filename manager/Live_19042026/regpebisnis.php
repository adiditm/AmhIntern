...
//echo "($fidmember,  $fnama, $fnohp, $falamat, $fprop,$fkota, $fkec, $femail, $fnoktp, $fket,$fnorekening,$fatasnama,$fnamabank,$faktif,$vTglAktif , $vExtDate,$db)";
    ...
    <div class="divtr col-lg-6 ">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-addon"> <i class="fa fa-id-card"></i></span>
                                    	...
                                    	<input type="text" maxlength="160" oninput="" class="form-control" id="fnamabank" name="fnamabank"  placeholder="Nama Bank *" value="<?=$vNamaBank?>">
