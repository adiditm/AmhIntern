						...
						while($db1->next_record()) {
							...
							while($dbin1->next_record()) {
								$vIDProg = $dbin1->f('fidprogram');
									  ...
									  $vSQLReg = "select count(a.fidmember) as fjml from m_anggota a left join tb_payhist b on a.fidmember=b.fidmember  where a.fidregistrar in ($vSQLUser) and a.flunas > 0 and a.fprogram='$vIDProg'  and a.fpaket='$vIDPaket' $vAnd ";
									//  if ($_SESSION['LoginUser'] == 'ADMIN_2') echo $vSQLReg;
						...
						while($db1->next_record()) {
							...
							while($dbin1->next_record()) {
								$vIDProg = $dbin1->f('fidprogram');
										...
										$vSQLReg = "select count(a.fidmember) as fjml from m_anggota a left join tb_payhist b on a.fidmember=b.fidmember where a.fidregistrar in ($vSQLUserSub) and a.flunas > 0 and a.fprogram='$vIDProg' and a.fpaket='$vIDPaket' $vAnd ";
						...
						while($db1->next_record()) {
							...
							while($dbin1->next_record()) {
								$vIDProg = $dbin1->f('fidprogram');
										...
										// $vSQLUserSub = "select fidmember from m_admin where fkorwil='$vIDKorwil'";
										 $vSQLReg = "select count(a.fidmember) as fjml from m_anggota a left join tb_payhist b on a.fidmember=b.fidmember where (a.fidregistrar in ($vSQLUserSpon) or a.fidregistrar in($vSQLUserOldSpon)) and a.flunas > 0 and a.fprogram='$vIDProg' and a.fpaket='$vIDPaket' $vAnd ";
		  ...
		  <?  
						...
						while($db1->next_record()) {
								$vIDPaket = $db1->f('fpackid');
									...
									while($dbin1->next_record()) {
								 	...
								 	$vSQLUser = "select fidmember from m_admin  where fkorwil='$vIDKorwil'";
									 $vSQLKTP = "select count(a.fidmember) as fjml from m_anggota a left join tb_payhist b on a.fidmember=b.fidmember where a.fidregistrar in ($vSQLUser)  and a.fprogram='$vIDProg' and a.flunas >0 and  a.fpaket='$vIDPaket' $vAnd ";
						...
						while($db1->next_record()) {
								$vIDPaket = $db1->f('fpackid');
									...
									$vSQLKTP = "select count(a.fidmember) as fjml from m_anggota  a left join tb_payhist b on a.fidmember=b.fidmember where a.fidregistrar in ($vSQLUserSub)  and a.fprogram='$vIDProg' and a.flunas >0 and  a.fpaket='$vIDPaket' $vAnd ";
						...
						while($db1->next_record()) {
								 ...
								 $vSQLUserSpon ="select a.fidmember from m_admin a left join m_anggota b on a.fidjamaah=b.fidmember where concat(b.fprop,b.fkota,b.fkec)  in($vSQLArea)";
											...
											$vSQLKTP = "select count(a.fidmember) as fjml from m_anggota a left join tb_payhist b on a.fidmember=b.fidmember where a.fidregistrar in ($vSQLUserSpon)  and a.fprogram='$vIDProg' and a.flunas >0 and  a.fpaket='$vIDPaket' $vAnd ";
