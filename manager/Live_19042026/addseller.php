...
//print_r($_POST);
 // $_SESSION['Ref']='';
	...
	$dbL = $db1;
     ...
     $vSQL="select a.* from m_seller a  where a.fidseller='$vUserActive'";
 
 	$dbL->query($vSQL);
 	$dbL->next_record();

   	$vIdPilgrimsL = $dbL->f('fidseller');
...
function generateRandomString($length = 6) {
   ...
   if ($_POST['hPost'] != '1') {
	 ...
	 $oSystem->smtpmailer('japri_s@yahoo.com',$vMailFrom,'AMH',"Registrasi AMH Internal",'','',false);
	  ...
	  $vhSubTot=0;	  	 
		 ...
		 $flastuser = $_SESSION['LoginUser'];
			 ...
			 if ($oMember->regSeller($fidseller, $fbank, $fnama, $fwaris, $fcomp, $fnohp, $falamat, $fprop,$fkota, $fkec,$fkel, $femail, $fnoktp, $fnib, $fnorekening, $fatasnama,$fcountry,$db)==1) {  
	...
	if($db->query('COMMIT;')) {	  
	   $oSystem->jsAlert("Penambahan data Seller sukses!");	
...
//	if(typeof $('#hTotJum').val() !== "undefined") {
 ...
 return true;
	   ...
	   alert('Anda belum melakukan entri data!');
 ...
 /*var vPaket=document.getElementById('rbPaket').value;
		    ...
		    if (confirm('Anda yakin melakukan penambahan data seller?')==true) {
...
function setNama(){
	var vNama =  $('#fidseller option:selected').text();
	vNama =  vNama.split('-');
	vNama = vNama[0];
	$('#fnama').val(vNama.trim());
}
...
<? } ?>
 ...
 <div class="right_col" role="main">
		...
		<div><label>
		<h3>Menambah Seller</h3></label></div> 
...
<form method="post" id="frmReg" name="frmReg" action="">
                     ...
                     <div class="panel-body" style="color:black">
							...
							<label for="exampleInputEmail1" >ID
							 ...
							 <div align="left" style="display:inline" id="statKit"></div></label>
                                    ...
                                    <select class="form-control m-bot15" id="fidseller" name="fidseller" onChange="setNama()">
                                <option  value="" selected="selected" >--Pilih / Choose--</option>
								<? 
								    $vSQL="select * from m_admin where fpriv='seller' and fidmember not in(select fidseller from m_seller) order by fnama";
								    $db->query($vSQL);
								    while ($db->next_record()) {
								?>                               
								 <option value="<?=$db->f('fidmember')?>"  ><?=$db->f('fnama')?> - <?=$db->f('fidmember')?></option>
								 <? } ?>
                            </select>
                              </div>                            
                            </div>
                          ...
                          <div class="divtr col-lg-6" >
								...
								Nama Pemilik*</label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-user"></i></span>
                                <input readonly type="text" class="form-control" id="fnama" name="fnama" placeholder="(Tanpa tanda koma)*" onBlur="this.value=this.value.replace(/,/g,'');$('#tfAtasNama').val(this.value);" onKeyUp="this.value=this.value.replace(/,/g,'');$('#tfAtasNama').val(this.value);" value="<?=$vNamaL?>">
                                </div>
</div>  
 ...
 <div class="divtr col-lg-6" >
								...
								Nama Ahli Waris*</label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-user"></i></span>
                                <input  type="text" class="form-control" id="fwaris" name="fwaris" placeholder="(Tanpa tanda koma)*" onBlur="this.value=this.value.replace(/,/g,'');$('#tfAtasNama').val(this.value);" onKeyUp="this.value=this.value.replace(/,/g,'');$('#tfAtasNama').val(this.value);" value="<?=$vWaris?>">
                                </div>
</div>    
        ...
        <div class="divtr col-lg-6 ">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-addon"> <i class="fa fa-id-card"></i></span>
                                    	...
                                    	<input type="text" maxlength="16" oninput="" class="form-control" id="fcomp" name="fcomp" onBlur="" placeholder="Nama Perusahaan*" value="<?=$vComp?>" >
      ...
      <div class="divtr col-lg-6 ">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-addon"> <i class="fa fa-id-card"></i></span>
                                    	...
                                    	<input type="text" maxlength="16" oninput="" class="form-control" id="fnoktp" name="fnoktp" onBlur="checkMultiIdent(this.value)" placeholder="No. KTP.*" value="<?=$vNoKTP?>" >
   ...
   <div class="divtr col-lg-6 ">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-addon"> <i class="fa fa-id-card"></i></span>
                                    	...
                                    	<input type="text" maxlength="16" oninput="" class="form-control" id="fnib" name="fnib" onBlur="checkMultiIdent(this.value)" placeholder="NIB*" value="<?=$vNIB?>" >
    ...
    <div class="divtr col-lg-6 ">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-addon"> <i class="fa fa-id-card"></i></span>
                                    	...
                                    	<input type="text" maxlength="160" oninput="" class="form-control" id="fbank" name="fbank"  placeholder="Nama Bank *" value="<?=$vNamaBank?>">
  ...
  <div class="divtr col-lg-6 ">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-addon"> <i class="fa fa-id-card"></i></span>
                                    	...
                                    	<input type="number" maxlength="16" oninput="" class="form-control" id="fnorekening" name="fnorekening"  placeholder="No. Rekening.*" value="<?=$vNoRek?>">
 ...
 <div class="divtr col-lg-6 ">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-addon"> <i class="fa fa-id-card"></i></span>
                                    	...
                                    	<input type="text" maxlength="160" oninput="" class="form-control" id="fatasnama" name="fatasnama"  placeholder="Atas Nama *" value="<?=$vAtasNama?>">
                   ...
                   <div class="form-group" >     
                        ...
                        <div class="divtr col-lg-12">
                            ...
                            <label for="exampleInputEmail1">Alamat Seller*</label>
  					 ...
  					 <div class="form-group"  id="kotaprovneg">                      
                               ...
                               <div class="col-lg-4 col-md-4 divtr" >
                                ...
                                <select style="pointer-events:none;background-color:#CCC" class="form-control m-bot15" id="fcountry" name="fcountry" onChange="prepareProp(this)">
...
<div class="divtr col-lg-6 ">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-addon"> <i class="fa fa-id-card"></i></span>
                                    	...
                                    	<input type="text" maxlength="160" oninput="" class="form-control" id="fkel" name="fkel"  placeholder="Kelurahan *" value="<?=$vKelurahan?>">
...
<div class="col-lg-6 divtr" >
								   ...
								   <span style="font-weight:bold">&nbsp;Nomor Telepon / WA*</span></label>
...
<div class="col-lg-6 divtr">
  ...
  <div class="form-inline">
    ...
    <input type="email" class="form-control" id="femail" name="femail" placeholder="Contoh: budi@yahoo.com"  value="<?=$vEmail?>">
  </div>
</div>
...
<div class="row">
                     ...
                     <? } ?>
                                        ...
                                        <button type="button" class="btn btn-default" onClick="document.location.href='../masterdata/aktifseller.php?op=&current=mdm_master_data&menu=mdm_master_data_editkor';" >Back &laquo;</button> 
