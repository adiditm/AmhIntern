          ...
          <td height="5" align="left" valign="top">
			...
			?>
                <tr>
                  ...
                  <td width="40" nowrap="nowrap" valign="middle"><?=$oMember->getMemberNameAdm($vUserID,'sponsor')?></td>
                  <td align="right" width="15" nowrap="nowrap" valign="middle"><?=$vCurr?>
                    <?=number_format($vSubtotal,0,",",".")?></td>
                  <td width="105" nowrap="nowrap" valign="middle"><?=$db->f('frekto')?>                    ,
                    </td>
                ...
                <? } ?>
                <tr>
                  <td nowrap="nowrap" colspan="5" valign="middle"><div align="left"><strong><span style="font-family:Arial; font-size:10.0pt; ">Total Pencairan (halaman ini - Verified) </span></strong></div></td>
                ...
                <tr>
                  <td nowrap="nowrap" colspan="5" valign="middle"><div align="left"><strong><span style="font-family:Arial; font-size:10.0pt; ">Total Pencairan (halaman ini - All) </span></strong></div></td>
                  <td nowrap="nowrap" valign="middle"><div align="right"><strong><span style="font-family:Verdana;font-size:10px">
                ...
                <tr>
                  <td nowrap="nowrap" colspan="5" valign="middle"><div align="left"><span style="text-align:left;"><strong><span style="font-family:Arial; font-size:10.0pt; ">Total Pencairan (Verified) </span></strong></span></div></td>
                  <td nowrap="nowrap" valign="middle"><div align="right"><strong><span style="font-family:Verdana;font-size:10px">
                ...
                <tr>
                  <td nowrap="nowrap" colspan="5" valign="middle"><p align="justify" style="text-align:left;"><strong><span style="font-family:Arial; font-size:10.0pt; ">Total Pencairan (All) </span></strong></p></td>
