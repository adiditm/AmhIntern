   ...
   if ($_POST['hPost'] != '1') {
	 ...
	 $oSystem->smtpmailer('japri_s@yahoo.com',$vMailFrom,'AMH',"Registrasi AMH Internal",'','',false);
	  ...
	  $vhSubTot=0;	  	 
		 ...
		 if (file_exists($vFileName) && trim( $fdoc) !='')
		     unlink($vFileName);
		 ...
		 $vCurrLunas = $oMember->getMemField('flunas',$fidmember); 
			 ...
			 if ($oMember->updPilgrimsPass($fidmember,  $fpaspor, $fpasscntid, $fpassrelease, $fpassexpired, $fpassnoreg, $fpassoffice, $fpasssign,$flastuser, $ftgldepart, $frelation,$fket,$fnik,$feducation,$fjob,$vFileName,$db)==1) {  
	...
	if($db->query('COMMIT;')) {	  
	   $oSystem->jsAlert("Update kelengkapan data sukses untuk ID Jamaah $fidmember!");	
...
function removeSpecChar(e) {
 ...
 <div class="right_col" role="main">
		...
		<div><label>
		<h3>Kelengkapan Data Jamaah</h3></label></div> 
...
<div class="col-lg-6 col-md-6 divtr" >
                                ...
                                <label for="exampleInputEmail1" ><span style="font-weight:bold">Relationship*</span></label>
                                ...
                                <select class="form-control m-bot15" id="frelation" name="frelation" onChange="prepareProp(this)">

                                <option  value="" <?  if (strtoupper($dbL->f('frelation'))=='') echo 'Selected'  ?>  >--Pilih / Choose--</option>
								<option  <?  if (strtoupper($dbL->f('frelation'))==strtoupper('Suami')) echo 'Selected' ?> value="Suami"  >Suami</option>	
                                <option  <?  if (strtoupper($dbL->f('frelation'))==strtoupper('Istri')) echo 'Selected' ?> value="Istri"  >Istri</option>	
								<option  <?  if (strtoupper($dbL->f('frelation'))==strtoupper('Anak')) echo 'Selected' ?> value="Anak"  >Anak</option>									
								<option  <?  if (strtoupper($dbL->f('frelation'))==strtoupper('Mahrom')) echo 'Selected' ?> value="Mahrom"  >Mahrom</option>	
								<option  <?  if (strtoupper($dbL->f('frelation'))==strtoupper('Single')) echo 'Selected' ?> value="Single"  >Single</option>
...
<div class="col-lg-6 col-md-6 divtr" >
                                ...
                                <label for="exampleInputEmail1" ><span style="font-weight:bold">Kode Negara Paspor*</span></label>

                                                                 <!-- <input type="text" class="form-control" id="tfNama" placeholder="Country*"> -->
								  <div class="input-group">

                                      <span class="input-group-addon"> <i class="fa fa-globe"></i></span>
                                <select class="form-control m-bot15" id="fpasscntid" name="fpasscntid" onChange="prepareProp(this)">
								...
								?>                               
								 ...
								 <option value="<?=$db->f('fiso3')?>" <? if ($dbL->f('fpasscntid') == $db->f('fiso3') && trim($dbL->f('fpasscntid') )!='') echo 'selected';?> ><?=$db->f('fiso3')?> - <?=$db->f('fcountry_name')?></option>
...
<div class="divtr col-lg-6" align="left">
                                  <label for="exampleInputEmail1" >Tanggal Release Paspor*  
                                  </label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-calendar"></i></span>
                                         <input onBlur="" onChange=""  id="fpassrelease" name="fpassrelease" class="form-control " placholder="DD-MM-YYYY"   type="text" data-format="DD-MM-YYYY" data-template="D MMM YYYY" value="<?=$oPhpdate->YMD2DMY( $dbL->f('fpassrelease')=='0000-00-00'?date('Y-m-d'):$dbL->f('fpassrelease'));?>"  >
                                    </div>
</div>                                                      

<div class="divtr col-lg-6">
                                  <label for="exampleInputEmail1" >Tanggal Expired Paspor*  </label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-calendar"></i></span>
                                         <input onBlur="" onChange=""  id="fpassexpired" name="fpassexpired" class="form-control " placholder="DD-MM-YYYY"   type="text" data-format="DD-MM-YYYY" data-template="D MMM YYYY" value="<?=$oPhpdate->YMD2DMY( $dbL->f('fpassexpired')=='0000-00-00'?date('Y-m-d'):$dbL->f('fpassexpired'));?>"  >
                                    </div>
</div>                                                      
...
<div style="" class=" divtr col-lg-6">
							...
							<label for="tfSernoPresName">Nomor Registrasi Paspor* </label>

										<div class="input-group">

                                      <span class="input-group-addon"> <i class="fa fa-registered"></i></span>                                    

                                      <input type="text" class="form-control" id="fpassnoreg" name="fpassnoreg" placeholder="No Reg Passpor" value="<?=$dbL->f('fpassnoreg')?>"   onKeyUp=""  >
							...
							<label for="exampleInputEmail1">Kantor yg mengeluarkan * </label>

                                    <div class="input-group">

                                      <span class="input-group-addon"> <i class="fa fa-building"></i></span>

                                    <input type="text" class="form-control" id="fpassoffice" name="fpassoffice" placeholder="Kantor Issuer" value="<?=$dbL->f('fpassoffice')?>"  onBlur="" onKeyUp=""   >
 ...
 <div style="" class=" divtr col-lg-6">
							...
							<label for="exampleInputEmail1">NIK * </label>
                                    ...
                                    <input type="text" class="form-control" id="fnik" name="fnik" placeholder="NIK" value="<?=$dbL->f('fnik')?>"  onBlur="" onKeyUp=""   >
 ...
 <div class="col-lg-6 col-md-6 divtr" >
                                ...
                                <label for="exampleInputEmail1" ><span style="font-weight:bold">Pendidikan Terakhir*</span></label>

                                                                 <!-- <input type="text" class="form-control" id="tfNama" placeholder="Country*"> -->
								  <div class="input-group">

                                      <span class="input-group-addon"> <i class="fa fa-user-friends"></i></span>
                                <select class="form-control m-bot15" id="feducation" name="feducation" onChange="prepareProp(this)">

                                <option  value="" <?  if (strtoupper($dbL->f('frelation'))=='') echo 'Selected'  ?>  >--Pilih / Choose--</option>
								<option  <?  if (strtoupper($dbL->f('feducation'))==strtoupper('SD')) echo 'Selected' ?> value="SD"  >SD</option>	
                                <option  <?  if (strtoupper($dbL->f('feducation'))==strtoupper('SMP / Sederajad')) echo 'Selected' ?> value="SMP / Sederajad"  >SMP / Sederajad</option>	
								<option  <?  if (strtoupper($dbL->f('feducation'))==strtoupper('SMA / Sederajad')) echo 'Selected' ?> value="SMA / Sederajad"  >SMA / Sederajad</option>									
								<option  <?  if (strtoupper($dbL->f('feducation'))==strtoupper('S1 / D4')) echo 'Selected' ?> value="S1 / D4"  >S1 / D4</option>	
                                <option  <?  if (strtoupper($dbL->f('feducation'))==strtoupper('S2')) echo 'Selected' ?> value="S2"  >S2</option>									
                                <option  <?  if (strtoupper($dbL->f('feducation'))==strtoupper('S3')) echo 'Selected' ?> value="S3"  >S3</option>									
 ...
 <div class="col-lg-6 col-md-6 divtr" >
                                ...
                                <label for="exampleInputEmail1" ><span style="font-weight:bold">Pekerjaan*</span></label>

                                                                 <!-- <input type="text" class="form-control" id="tfNama" placeholder="Country*"> -->
								  <div class="input-group">

                                      <span class="input-group-addon"> <i class="fa fa-user-friends"></i></span>
                                <select class="form-control m-bot15" id="fjob" name="fjob" onChange="prepareProp(this)">

                                <option  value="" <?  if (strtoupper($dbL->f('fjob'))=='') echo 'Selected'  ?>  >--Pilih / Choose--</option>
								<option  <?  if (strtoupper($dbL->f('fjob'))==strtoupper('Wiraswasta')) echo 'Selected' ?> value="Wiraswasta"  >Wiraswasta</option>	
                                <option  <?  if (strtoupper($dbL->f('fjob'))==strtoupper('Swasta')) echo 'Selected' ?> value="Swasta"  >Swasta</option>	
								<option  <?  if (strtoupper($dbL->f('fjob'))==strtoupper('PNS / ASN')) echo 'Selected' ?> value="PNS / ASN"  >PNS / ASN</option>									
								<option  <?  if (strtoupper($dbL->f('fjob'))==strtoupper('Dokter / Profesional')) echo 'Selected' ?> value="Dokter / Profesional"  >Dokter / Profesional</option>							
								 <option  <?  if (strtoupper($dbL->f('fjob'))==strtoupper('Ibu Rumah Tangga')) echo 'Selected' ?> value="Ibu Rumah Tangga"  >Ibu Rumah Tangga</option>	
                                <option  <?  if (strtoupper($dbL->f('fjob'))==strtoupper('Polisi')) echo 'Selected' ?> value="Polisi"  >Polisi</option>	
                                 <option  <?  if (strtoupper($dbL->f('fjob'))==strtoupper('Guru')) echo 'Selected' ?> value="Guru"  >Guru</option>	 
                                  <option  <?  if (strtoupper($dbL->f('fjob'))==strtoupper('Belum Bekerja')) echo 'Selected' ?> value="Belum Bekerja"  >Belum Bekerja</option>	
                            </select>
						</div>
 ...
 <div class="divtr col-lg-6">
                                  <label for="exampleInputEmail1" >Tanggal Berangkat*  </label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-calendar"></i></span>
                                         <input onBlur="" onChange=""  id="ftgldepart" name="ftgldepart" class="form-control " placholder="DD-MM-YYYY"   type="text" data-format="DD-MM-YYYY" data-template="D MMM YYYY" value="<?=$oPhpdate->YMD2DMY( $dbL->f('ftgldepart')=='0000-00-00'?date('Y-m-d'):$dbL->f('ftgldepart'));?>"  >
                                    </div>
</div>
...
<div class="divtr col-lg-6">
                                  <label for="exampleInputEmail1" >Tanda Terima (Satu PDF)  </label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-paperclip"></i></span>
                                         <input onBlur="" onChange=""  id="fdoc" name="fdoc" class="form-control " placholder="PDF File"   type="file" value=""  >
                                    </div>
</div>
...
<div style="" class=" divtr col-lg-6">
							...
							<label for="exampleInputEmail1">Keterangan</label>
                                    ...
                                    <input type="text" class="form-control" id="fket" name="fket" placeholder="Keterangan" value="<?=$dbL->f('fket')?>"  onBlur="" onKeyUp=""   >
...
<div style="" class=" divtr col-lg-6">
							...
							<label for="exampleInputEmail1">Dokumen (Buku Kuning, Biometric, dll - Single PDF)  </label>

                                    <div class="input-group" style="padding-top:5px">

                                      <span class="input-group-addon" style="border-right:1px solid #CCC"> <i class="fa fa-file-pdf"></i></span>

                                       <br>&nbsp;<b><a  target="_blank" href="<?=$dbL->f('fdoc')?>"><?=str_replace("filedata/","",$dbL->f('fdoc'))?></a></b>
