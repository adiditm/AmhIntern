...
<div class="divtr col-lg-6">
                                  <label for="exampleInputEmail1" >Tanggal Berangkat*  </label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-calendar"></i></span>
                                          <select class="form-control m-bot15" id="ftgldepart" name="ftgldepart" onChange="spreadPProg(this.value,$('#fprogram').val(),$('#fpaket').val())">
                                <option  value="" selected="selected" >--Pilih / Choose--</option>
								<? 
...
<div style="" class=" divtr col-lg-6">
							...
							<label for="tfSernoPresName">Setoran Awal* </label>
                                      ...
                                      <input type="text" class="form-control" id="fstorawal" name="fstorawal" placeholder="0" value="0"  dir="rtl" onKeyUp="if (!isNaN(this.value) && this.value !='') calcPay();"  >
