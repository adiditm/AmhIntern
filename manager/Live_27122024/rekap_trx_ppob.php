...
$opts['filters'] = 'PMEtable0.fket like \'Transaksi PPOB%\' '.$vAddFilter;
...
<?
 $vSQL ="select sum(fhrgamh) as ftotal from tb_trxpulsa where fket like 'Transaksi PPOB%' $vAddFilter ";
$db->query($vSQL);
