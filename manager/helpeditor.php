  ...
  // $vContent=addslashes($_POST['elm1']);
   ...
   if ($vNamePost!="") {
	 ...
	 if ($vUpdate==1) {
	       ...
	       $oSystem->jsLocation("../manager/helpeditor.php?&uMenuname=$vMenuPost&uGroup=$vGroupPost&op=&current=mdm_master_content&menu=mdm_master_data_setinfo");
...
function changeMenu() {
	  ...
	  window.location='helpeditor.php?menu=editor&uMenuname='+menuName+'&uGroup='+menuGroup+'&op=&current=mdm_master_content&menu=mdm_content_help';
...
function changeGroup() {
	  ...
	  window.location='helpeditor.php?menu=editor&uGroup='+menuGroup+'&op=&current=mdm_master_content&menu=mdm_content_help';
...
<div class="right_col" role="main">
		...
		<div><label>
		<h3>Editor Panduan</h3></label></div>
...
<form method="post" action="helpeditor.php" name="frmEditor" onsubmit="return doSubmit()">
