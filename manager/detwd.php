<?
  ...
  define("MENU_ID", "royal_page_edit");   
   ...
   while ($db->next_record()) {
	  ...
	  $vID=$db->f("fidmember");
	  $vJumlah=$db->f("fnominal");
	  $vRekening=$db->f("frekto");
	...
	<table width="90%"  border="0" align="center" cellpadding="1" cellspacing="1" style="font-family:Tahoma,Verdana" class="table">
      ...
      <tr>
        ...
        <td colspan="3" align="center">
          ...
          <p><strong>Detail Pencairan </strong></p>          </td>
      ...
      <tr>
        <td>Nama</td>
        <td align="left">:</td>
        <td><?=$oMember->getMemFieldBis('fnama',$vID)?></td>
      </tr>
     ...
     <tr>
        ...
        <td><div align="left">
          ...
          <? 
		    ...
		    if ($vStatus=='2' || $vStatus=='4') {
				...
				echo " by $vAdmin";
        if ($vStatus=='2' && $vNoteAdm !='')
           echo "/Ref. No. $vNoteAdm";
      ...
      <tr>
        ...
        <td  colspan="3" valign="top"><p align="center"><br />
          ...
          <input type="button"  value="Close" onclick="window.close()" class="btn btn-success" />
