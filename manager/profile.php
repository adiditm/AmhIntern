...
<div style="" class=" divtr col-lg-6">
							<label for="exampleInputEmail1">Harga* <div align="left" style="display:inline" id="statKitUp"></div></label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-money"></i></span>
                                    <input type="text" class="form-control" id="fprice" name="fprice" placeholder="0" value="<?=$dbL->f('fprice')?>"  onBlur="" dir="rtl" onKeyUp="" readonly   >
                                    </div>                            
 </div>
...
<div style="" class=" divtr col-lg-6">
							<label for="exampleInputEmail1">Airport Tax Handle* <div align="left" style="display:inline" id="statKitUp"></div></label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-money"></i></span>
                                    <input type="text" class="form-control" id="fairporttax" name="fairporttax" placeholder="0" value="<?=$dbL->f('fairporttax')?>"  onBlur="" dir="rtl" onKeyUp=""  readonly >
                                    </div>                            
 </div>
...
<div style="" class=" divtr col-lg-6">
							<label for="exampleInputEmail1">Asuransi Indonesia* <div align="left" style="display:inline" id="statKitUp"></div></label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-money"></i></span>
                                    <input type="text" class="form-control" id="fassure" name="fassure" placeholder="0" value="<?=$dbL->f('fassure')?>"  onBlur="" dir="rtl" onKeyUp="" readonly  >
                                    </div>                            
 </div>
 ...
 <div style="" class=" divtr col-lg-6">
							<label for="exampleInputEmail1">Asuransi Arab Saudi* <div align="left" style="display:inline" id="statKitUp"></div></label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-money"></i></span>
                                    <input type="text" class="form-control" id="farabassure" name="farabassure" placeholder="0" value="<?=$dbL->f('farabassure')?>"  onBlur="" dir="rtl" onKeyUp=""  readonly  >
                                    </div>                            
 </div>
...
<div style="" class=" divtr col-lg-6">
							...
							<label for="tfSernoPresName">Setoran Awal* </label>
                                      ...
                                      <input type="text" class="form-control" id="fstorawal" name="fstorawal" placeholder="0" value="<?=$dbL->f('fstorawal')?>"  dir="rtl" onKeyUp="if (!isNaN(this.value) && this.value !='') calcPay();" readonly  >
							...
							<label for="exampleInputEmail1">Angsuran 1* <div align="left" style="display:inline" id="statKitUp"></div></label>
                                    ...
                                    <input type="text" class="form-control" id="fangsur1" name="fangsur1" placeholder="0" value="<?=$dbL->f('fangsur1')?>"  onBlur="" dir="rtl" onKeyUp="if (!isNaN(this.value) && this.value !='') calcPay();" readonly  >
...
<div style="" class=" divtr col-lg-6">
							...
							<label for="tfSernoSponName">Angsuran 2 </label>
                                      ...
                                      <input type="text" class="form-control" id="fangsur2" name="fangsur2" placeholder="0" value="<?=$dbL->f('fangsur2')?>"  dir="rtl"  onKeyUp="if (!isNaN(this.value) && this.value !='') calcPay();"  readonly>
...
<div style="" class=" divtr col-lg-6">
							...
							<label for="tfSernoSponName">Angsuran 3 </label>
                                      ...
                                      <input type="text" class="form-control" id="fangsur3" name="fangsur3" placeholder="0" value="<?=$dbL->f('fangsur3')?>"  dir="rtl"  onKeyUp="if (!isNaN(this.value) && this.value !='') calcPay();"  readonly>
...
<div style="" class=" divtr col-lg-6">
							...
							<label for="tfSernoSponName">Angsuran 4 </label>
                                      ...
                                      <input type="text" class="form-control" id="fangsur4" name="fangsur4" placeholder="0" value="<?=$dbL->f('fangsur4')?>"  dir="rtl"  onKeyUp="if (!isNaN(this.value) && this.value !='') calcPay();"  readonly>
...
<div style="" class=" divtr col-lg-6">
							...
							<label for="tfSernoSponName">Pelunasan </label>
                                      ...
                                      <input type="text" class="form-control" id="flunas" name="flunas" placeholder="0" value="<?=$dbL->f('flunas')?>"  dir="rtl"  onKeyUp="if (!isNaN(this.value) && this.value !='') calcPay();"  readonly>
    ...
    <div style="" class=" divtr col-lg-6">
							...
							<label for="tfSernoSponName">Total Pembayaran </label>
                                      ...
                                      <input type="text" class="form-control" id="ftotalbayar" name="ftotalbayar" placeholder="0" value="<?=$dbL->f('ftotalbayar')?>"  dir="rtl"  readonly >
