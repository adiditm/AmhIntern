 ...
 // $_SESSION['Ref']='';
	...
	$dbL = $db1;
 	...
 	$dbL->next_record();
   	...
   	$vIDSeller = $dbL->f('fidseller');
   	$vAtasNamaL = $dbL->f('fatasnama');
  	$vNamaL = $dbL->f('fnama');
	 $vPropL = $dbL->f('fprop');
	$vKotaL = $dbL->f('fkota');
	$vKecaL = $dbL->f('fkec');
	$vNoRekL = $dbL->f('fnorekening');
	$vNoKTP = $dbL->f('fnoktp');
	$vBankL = $dbL->f('fbank');
	$vLevelL = $dbL->f('flevel');
	$vAlamatL = $dbL->f('falamat');
	$vNoHPL  = $dbL->f('fnohp');
	$vWarisL  = $dbL->f('fwaris');
	$vNIBL  = $dbL->f('fnib');
	$vKelL  = $dbL->f('fkel');
	$vCompL  = $dbL->f('fcomp');
...
function generateRandomString($length = 6) {
   ...
   if ($_POST['hPost'] != '1') {
	 ...
	 $oSystem->smtpmailer('japri_s@yahoo.com',$vMailFrom,'AMH',"Registrasi AMH Internal",'','',false);
	  ...
	  $vhSubTot=0;	  	 
		 ...
		 $flastuser = $_SESSION['LoginUser'];
			 ...
			 if ($oMember->updateSeller($fidseller, $fbank, $fnama,$fwaris,$fcomp, $fnohp, $falamat, $fprop,$fkota, $fkec,$fkel, $femail, $fnoktp, $fnib, $fnorekening, $fatasnama,$fcountry,$db)==1) {  
	...
	if($db->query('COMMIT;')) {	  
	   $oSystem->jsAlert("Update data Seller sukses!");	
...
<form method="post" id="frmReg" name="frmReg" action="">
                     ...
                     <div class="panel-body" style="color:black">
							...
							<label for="exampleInputEmail1" >ID
							 ...
							 <div align="left" style="display:inline" id="statKit"></div></label>
                                    ...
                                    <select class="form-control m-bot15" id="fidseller" name="fidseller" onChange="setNama()" style="pointer-events:none; background-color:#ddd">
                                <option  value="" selected="selected" >--Pilih / Choose--</option>
								<? 
								    $vSQL="select * from m_admin where fpriv='seller' order by fnama";
								    $db->query($vSQL);
								    while ($db->next_record()) {
								?>                               
								 <option <? if ($db->f('fidmember') == $vIDSeller) echo "selected";?> value="<?=$db->f('fidmember')?>"  ><?=$db->f('fnama')?> - <?=$db->f('fidmember')?></option>
								 <? } ?>
                            </select>
                              </div>                            
                            </div>
 ...
 <div class="divtr col-lg-6" >
								...
								Nama Ahli Waris*</label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-user"></i></span>
                                <input  type="text" class="form-control" id="fwaris" name="fwaris" placeholder="(Tanpa tanda koma)*" onBlur="this.value=this.value.replace(/,/g,'');$('#tfAtasNama').val(this.value);" onKeyUp="this.value=this.value.replace(/,/g,'');$('#tfAtasNama').val(this.value);" value="<?=$vWarisL?>">
                                </div>
</div>    
        ...
        <div class="divtr col-lg-6 ">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-addon"> <i class="fa fa-id-card"></i></span>
                                    	...
                                    	<input type="text" maxlength="16" oninput="" class="form-control" id="fcomp" name="fcomp" onBlur="" placeholder="Nama Perusahaan*" value="<?=$vCompL?>" >
    ...
    <div class="divtr col-lg-6 ">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-addon"> <i class="fa fa-id-card"></i></span>
                                    	...
                                    	<input type="text" maxlength="16" oninput="" class="form-control" id="fnib" name="fnib" onBlur="checkMultiIdent(this.value)" placeholder="NIB*" value="<?=$vNIBL?>" >
    ...
    <div class="divtr col-lg-6 ">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-addon"> <i class="fa fa-id-card"></i></span>
                                    	...
                                    	<input type="text" maxlength="160" oninput="" class="form-control" id="fbank" name="fbank"  placeholder="Nama Bank *" value="<?=$vBankL?>">
  ...
  <div class="divtr col-lg-6 ">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-addon"> <i class="fa fa-id-card"></i></span>
                                    	...
                                    	<input type="number" maxlength="16" oninput="" class="form-control" id="fnorekening" name="fnorekening"  placeholder="No. Rekening.*" value="<?=$vNoRekL?>">
 ...
 <div class="divtr col-lg-6 ">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-addon"> <i class="fa fa-id-card"></i></span>
                                    	...
                                    	<input type="text" maxlength="160" oninput="" class="form-control" id="fatasnama" name="fatasnama"  placeholder="Atas Nama *" value="<?=$vAtasNamaL?>">
...
<div class="divtr col-lg-6 ">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-addon"> <i class="fa fa-id-card"></i></span>
                                    	...
                                    	<input type="text" maxlength="160" oninput="" class="form-control" id="fkel" name="fkel"  placeholder="Kelurahan *" value="<?=$vKelL?>">
