...
<div class="right_col" role="main">
		<div><label><h3>Top Referensi  <?=$vCText?></h3></label></div>
...
<div align="center" class="table-responsive"> 
		  ...
		  <table border="0" cellpadding="4" cellspacing="0"  align="left"  >
            ...
            <tr  >
              ...
              <td height="25"><div align="left"><strong>Referensi Reg. Pack</strong></div></td>
            ...
            <tr >
              ...
              <td style="height: 25px; width: 39%;"><div align="left">
                ...
                <select name="lmSort" class="form-control" id="lmSort">
                  ...
                  <option value="1" <? if ($vSort=="1") echo "selected";?>>Referensi Count Ascending</option>

                  <option value="2" <? if ($vSort=="2") echo "selected";?>>Referensi Count Descending</option>
