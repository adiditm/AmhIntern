		...
		<div class="divtr col-lg-12" >
             ...
             <? if (true) { ?>               				   
				...
				<div class="col-lg-6 col-md-6 divtr" >
				   <label   for="tfNama">Barang Bawaan</label>
                                    <div class="col-lg-12">
...
<div class="row">  <input name="fidentpasporfc"  id="fidentpasporfc" type="checkbox" value="1" <? if ($vArrIdentL['fidentpasporfc']=='1') echo 'checked'; ?>> 
                          ...
                          <div class="divtr col-lg-6">
                                   <label   for="tfNama">&nbsp;&nbsp;</label>
                                    	...
                                    	KTP Asli</div>
                                        <div class="row">  <input name="fidentktpfc"  id="fidentktpfc" type="checkbox" value="1" <? if ($vArrIdentL['fidentktpfc']=='1') echo 'checked'; ?>>
                                        KTP Fotocopy</div>
...
<div class="divtr col-lg-6">
                                  <label for="exampleInputEmail1" >Tanda Terima (Satu file PDF)  </label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-paperclip"></i></span>
                                         <input onBlur="" onChange=""  id="fcheckidentdoc" name="fcheckidentdoc" class="form-control " placholder="Satu File PDF"   type="file" value=""  >
                                    </div>
</div>
							...
							<label for="exampleInputEmail1">Dokumen (Buku Kuning, Biometric, dll - Single PDF)  </label>
                                    ...
                                    <div class="input-group" style="padding-top:5px">
                                      ...
                                      <span class="input-group-addon" style="border-right:1px solid #CCC"> <i class="fa fa-file-pdf"></i></span>
                                       <? 
                                          $filedata=str_replace("filebring/","filedata/",$dbL->f('fbringdoc'));
                                          $filedata=str_replace("bring-","",$filedata);
                                       ?> 
                                       <br>&nbsp;<b><a  target="_blank" href="<?=$filedata?>"><?=$filedata?></a></b>
