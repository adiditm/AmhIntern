...
//print_r($_FILES);
 // $_SESSION['Ref']='';
	...
	$vPropL = $dbL->f('fprop');
	$vKotaL = $dbL->f('fkota');
	$vBringL = $dbL->f('fbring');
	$vArrBringL = json_decode($vBringL,true);
...
function generateRandomString($length = 6) {
   ...
   if ($_POST['hPost'] != '1') {
	 ...
	 $oSystem->smtpmailer('japri_s@yahoo.com',$vMailFrom,'AMH',"Registrasi AMH Internal",'','',false);
	  ...
	  $vhSubTot=0;	  	 
		 ...
		 foreach($vPost as $key=>$val) {
			   if (preg_match("/fbawa/",$key)) {
				    $vArrBawa[$key] = $val;  
			   }
		 }
		 $vBawaJSON = json_encode($vArrBawa,1);
		// print_r($vBawaJSON);
	
		 $fdoc = $_FILES['fbringdoc']['name'];
		 $tmp_name = $_FILES['fbringdoc']['tmp_name'];
		 $vLowName = strtolower($oMember->getMemberName($fidmember));
		 $vLowName = str_replace(" ","_",$vLowName);
		 $vFileName = "filebring/bring-$fidmember-$vLowName".".pdf";
		...
		// print_r($_POST);		  
			 if ($oMember->updPilgrimsBring($fidmember,  $vBawaJSON,$vFileName,$db)==1) {  
	...
	if($db->query('COMMIT;')) {	  
	   $oSystem->jsAlert("Update kelengkapan barang bawaan sukses untuk ID Jamaah $fidmember!");	
...
//$('.year').css("max-width", "90px");*/
 ...
 // $.validator.messages.required = '<span style="color:red;font-weight:normal">This field is required!</span>';
  ...
  $('#frmReg input, #frmReg textarea,  #frmReg select, #frmReg checkbox, #frmReg radio').not([type="submit"]).not($("#fidmember")).not($("#fbawakoper")).not($("#fbawatpaspor")).not($("#fbawabukudoa")).not($("#fbawaikrom")).not($("#fbawatkabin")).not($("#fbawakainser")).not($("#fbawasabuk")).not($("#fbawalain")).not($("#fbringdoc")).addClass('required');  
...
function removeSpecChar(e) {
 ...
 <div class="right_col" role="main">
		...
		<div><label>
		<h3> Tanda Terima Barang Bawaan</h3></label></div> 



<form method="post" id="frmReg" name="frmReg" action="printbawa.php?uMemberId=<?=$vUserActive?>" target="_bawa" enctype="multipart/form-data" >
 ...
 <option value="">--Pilih Jenis--</option>
		...
		<div class="divtr col-lg-12" >
             ...
             <? if ($dbL->f('fsex')=='F') { ?>               				   
				...
				<div class="col-lg-6 col-md-6 divtr" >
				   <label   for="tfNama">Barang Bawaan dan Jumlah</label>
                                    <div class="col-lg-12">
                                     <div class="row">   <input name="fbawakoper"  id="fbawakoper" type="checkbox" value="1" <? if ($vArrBringL['fbawakoper']=='1') echo 'checked'; ?>> Tas Koper <input name="tfbawakoper" type="text" value="1" size="4"></div>
                                       <div class="row"> <input name="fbawatpaspor"  id="fbawatpaspor" type="checkbox" value="1" <? if ($vArrBringL['fbawatpaspor']=='1') echo 'checked'; ?>> 
                                       Tas Passport 
                                         <input name="tfbawatpaspor" type="text" value="1" size="4">
                                       </div>
                                      <div class="row">  <input name="fbawabukudoa"  id="fbawabukudoa" type="checkbox" value="1" <? if ($vArrBringL['fbawabukudoa']=='1') echo 'checked'; ?>> 
                                      Buku Doa 
                                        <input name="tfbawabukudoa" type="text" value="1" size="4">
                                      </div>
                                     <div class="row">   <input name="fbawabergok"  id="fbawabergok" type="checkbox" value="1" <? if ($vArrBringL['fbawabergok']=='1') echo 'checked'; ?>> 
                                     Bergo Kecil 
                                       <input name="tfbawabergok" type="text" value="1" size="4">
                                     </div>
                                      </div>  
                </div>
                          ...
                          <div class="divtr col-lg-6">
                                   <label   for="tfNama">&nbsp;&nbsp;</label>
										<div class="col-lg-12">
                                    	<div class="row">  <input name="fbawatkabin"  id="fbawatkabin" type="checkbox" value="1" <? if ($vArrBringL['fbawatkabin']=='1') echo 'checked'; ?>> 
                                    	Tas Kabin 
                                    	  <input name="tfbawatkabin" type="text" value="1" size="4">
                                    	</div>
                                        <div class="row">  <input name="fbawakainser"  id="fbawakainser" type="checkbox" value="1" <? if ($vArrBringL['fbawakainser']=='1') echo 'checked'; ?>> 
                                        Kain Seragam 
                                          <input name="tfbawakainser" type="text" value="1" size="4">
                                        </div>
                                        <div class="row">  <input name="fbawabergob"  id="fbawabergob" type="checkbox" value="1" <? if ($vArrBringL['fbawabergob']=='1') echo 'checked'; ?>> 
                                        Bergo Besar 
                                          <input name="tfbawabergob" type="text" value="1" size="4">
                                        </div>
                                        <div class="row">  <input name="fbawalain"  id="fbawalain" type="checkbox" value="1" <? if ($vArrBringL['fbawalain']=='1') echo 'checked'; ?>> 
                                        Lainnya  
                                          <input name="tfbawalain" type="text" value="1" size="4">
                                        </div>
                                        </div>
      ...
      <? } else { //L ?>                           
		<div class="col-lg-6 col-md-6 divtr" >
				   <label   for="tfNama">Barang Bawaan dan Jumlah</label>
                                    <div class="col-lg-12">
                                     <div class="row">   <input name="fbawakoper"  id="fbawakoper" type="checkbox" value="1" <? if ($vArrBringL['fbawakoper']=='1') echo 'checked'; ?>> 
                                     Tas Koper 
                                       <input name="tfbawakoper" type="text" value="1" size="4">
                                     </div>
                                       <div class="row"> <input name="fbawatpaspor"  id="fbawatpaspor" type="checkbox" value="1" <? if ($vArrBringL['fbawatpaspor']=='1') echo 'checked'; ?>> 
                                       Tas Passport 
                                         <input name="tfbawatpaspor" type="text" value="1" size="4">
                                     ...
                                     <div class="row">   <input name="fbawaikrom"  id="fbawaikrom" type="checkbox" value="1" <? if ($vArrBringL['fbawaikrom']=='1') echo 'checked'; ?>> 
                                     Kain Ikrom 
                                       <input name="tfbawaikrom" type="text" value="1" size="4">
                                     </div>
                                      </div>  
                </div>
                          ...
                          <div class="divtr col-lg-6">
                                   <label   for="tfNama">&nbsp;&nbsp;</label>
                                        ...
                                        <div class="row">  <input name="fbawasabuk"  id="fbawasabuk" type="checkbox" value="1" <? if ($vArrBringL['fbawasabuk']=='1') echo 'checked'; ?>> 
                                        Sabuk 
                                          <input name="tfbawasabuk" type="text" value="1" size="4">
                                        </div>
                                        <div class="row">  <input name="fbawalain"  id="fbawalain" type="checkbox" value="1" <? if ($vArrBringL['fbawalain']=='1') echo 'checked'; ?>> 
                                        Lainnya  
                                          <input name="tfbawalain" type="text" value="1" size="4">
...
<div class="row">
                     ...
                     <? } ?>
                                     ...
                                     <? if (preg_match("/listregooo.php/",$vRefer) || preg_match("/aktif.php/",$vRefer)) {?>
									    <button id="btnSubmit" type="button" class="btn btn-info"  onClick="printBawa(this)">Print Tanda Terima</button> <div id="divLoad" style="display:inline">
									<? } ?>	
                                        <? if ($fidmember=='') $fidmember = $vUserActive;?>
                                        <?
                                           $vReferBack='';
										   $vReferBack=$_SERVER['HTTP_REFERER'].'&choosed='.$fidmember;
										?>
                                         <button id="btnBack" type="button" class="btn btn-default"  onClick="document.location.href='<?=$vReferBack?>'">Back</button> <div id="divLoad" style="display:inline">
