						...
						while($db1->next_record()) {
							$vIDPaket = $db1->f('fpackid');
								...
								while($dbin1->next_record()) {
										...
										$vSQLKTP = "select count(a.fidmember) as fjml from m_anggota a left join tb_payment b on a.fidmember=b.fidmember where concat(a.fprop,a.fkota,a.fkec) in ($vSQLArea)  and a.fprogram='$vIDProg' and  a.fpaket='$vIDPaket' and a.flunas >0 $vAnd ";
