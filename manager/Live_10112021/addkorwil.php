...
<? } ?>
 ...
 <div class="right_col" role="main">
		...
		<div><label>
		<h3>Menambah Korwil</h3></label></div> 
...
<div class="col-md-5 col-lg-6 divtr" >
								...
								<? 
								    $vSQL="select * from m_level_korwil where flevelid='KOR' order by fidsys";
								    $db->query($vSQL);
								    while ($db->next_record()) {
								?>                               
...
<div class="row">
                     ...
                     <? } ?>
                                        ...
                                        <button type="button" class="btn btn-default" onClick="document.location.href='../masterdata/aktifkorwil.php?op=&current=mdm_master_data&menu=mdm_master_data_editkor';" >Back &laquo;</button> 
