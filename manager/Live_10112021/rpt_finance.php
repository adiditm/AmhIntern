...
<div class="row">
		<div><label>
		<h3>Laporan Keuangan</h3></label></div>  		       
...
<div class="row"> 
               <div class="col-lg-2">
               <b> Filter Paket</b>  </div>
              <div class="col-lg-2">
                  <select class="form-control m-bot15" id="fpaket" name="fpaket">
                                <option  value="" selected="selected" >--Pilih / Choose--</option>
								<? 
								    $vSQLPack="select * from m_paket order by fidsys";
								    $dbin->query($vSQLPack);
								    while ($dbin->next_record()) {
								?>                               
								 <option value="<?=$dbin->f('fpackid')?>" <? if ($vFPaket == $dbin->f('fpackid')) echo "selected";?>  ><?=$dbin->f('fpackname')?></option>
								 <? } ?>
                            </select>
          </div>
...
<div>&nbsp;</div>
        <div class="row"> 
               <div class="col-lg-2">
               <b> Filter Harga </b>  </div>
              <div class="col-lg-2">
               <input name="fprice" id="fprice" type="text" class="form-control" value="<?=$vFHarga?>" />
          </div>
 ...
 <div>&nbsp;</div>
        <div class="row"> 
               <div class="col-lg-2">
               <b> Filter Airport Tax Handle </b>  </div>
              <div class="col-lg-2">
               <input name="fairporttax" id="fairporttax" type="text" class="form-control" value="<?=$vFAirport?>" />
          </div>
 ...
 <div>&nbsp;</div>
        <div class="row"> 
               <div class="col-lg-2">
               <b> Filter Asuransi</b>  </div>
              <div class="col-lg-2">
               <input name="fassure" id="fassure" type="text" class="form-control" value="<?=$vFAssure?>" />
          </div>
...
<tr style="font-weight:bold">
  ...
  <td  width="150" align="center">Setoran Awal</td>
  ...
  <tbody>      
		...
		?>
        <tr ><td style="text-align: right;vertical-align:middle" valign="middle" ><?=$vCount?></td>
          ...
          <td align="right" valign="middle" style="vertical-align:middle"><?=number_format($db->f('fstorawal'),0,",",".") ?></td>
