						...
						while($db1->next_record()) {
							$vIDPaket = $db1->f('fpackid');
								...
								$dbin1->query($vSQLProg);
									...
									$vSyaratLns = $dbin1->f('fsyaratlns');
								if ($vSyaratLns !=0) {	
									$vSQLKTP = "select count(a.fidmember) as fjml from m_anggota a left join tb_payment b on a.fidmember=b.fidmember where a.frefer='$vRefer'  and a.fprogram='$vIDProg' and  a.fpaket='$vIDPaket'  and a.flunas > 0 $vAnd ";
								} else {
