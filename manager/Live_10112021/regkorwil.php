...
//print_r($_POST);
 // $_SESSION['Ref']='';
	...
	$vNoHPL  = $dbL->f('fnohp');
	$vUplineL  = $dbL->f('fidupline');
	$vPebisnisL  = $dbL->f('fidbisnis');
	 ...
	 $oSystem->smtpmailer('japri_s@yahoo.com',$vMailFrom,'AMH',"Registrasi AMH Internal",'','',false);
	  ...
	  $vhSubTot=0;	  	 
		 ...
		 $flastuser = $_SESSION['LoginUser'];
			 ...
			 if ($oMember->updateKorwil($fidkorwil, $flevel, $fnama, $fnohp, $falamat, $fprop,$fkota, $fkec, $femail, $fnoktp, $fket,$fidupline,$fidbisnis,$db)==1) {  
		...
		//	$oMember->updMemCount($vYear,$vMonth,$vCounter,$db);
			...
			if ($fangsur1 > 0) {
				   ...
				   $oKomisi->insertPayment($fidmember,$fidmember,date("Y-m-d H:i:s"),$vDesc,$fangsur1,0,$vNom,'angs1') ;
			}
			...
			if ($fangsur2 > 0) {
				   ...
				   $oKomisi->insertPayment($fidmember,$fidmember,date("Y-m-d H:i:s"),$vDesc,$fangsur2,0,$vNom,'angs2') ;
			}
			...
			if ($fangsur3 > 0) {
				   ...
				   $oKomisi->insertPayment($fidmember,$fidmember,date("Y-m-d H:i:s"),$vDesc,$fangsur3,0,$vNom,'angs3') ;
			}
			...
			if ($fangsur3 > 0) {
				   ...
				   $oKomisi->insertPayment($fidmember,$fidmember,date("Y-m-d H:i:s"),$vDesc,$fangsur4,0,$vNom,'angs4') ;
			}
			...
			if ($flunas > 0) {
				   ...
				   $oKomisi->insertPayment($fidmember,$fidmember,date("Y-m-d H:i:s"),$vDesc,$flunas,0,$vNom,'lunas') ;
			}


	if($db->query('COMMIT;')) {	  
	   $oSystem->jsAlert("Update Korwil sukses!");	
...
<? } ?>
 ...
 <div class="right_col" role="main">
		...
		<div><label>
		<h3>Edit <? if($_GET['j']=='sub') echo 'Sub '?>Korwil</h3></label></div> 
                ...
                <div class="panel panel-default" id="panelkiri" >
                    ...
                    <div class="panel-heading" >
                             ...
                             <div class="panel-title" style="margin-top:0px">
								 ...
								 Data <? if($_GET['j']=='sub') echo 'Sub '?>Korwil</label>
                     ...
                     <div class="panel-body" style="color:black">
							...
							<label for="exampleInputEmail1" >Username
							 ...
							 <div align="left" style="display:inline" id="statKit"></div></label>
                                    ...
                                    <input readonly type="text" class="form-control" id="fidkorwil" name="fidkorwil" value="<?=$vIdPilgrimsL?>"    >
                              </div>                            
                            </div>
...
<div class="col-md-5 col-lg-6 divtr" >
                                 ...
                                 <select class="form-control m-bot15" id="flevel" name="flevel" style="background-color:#CCC">
                                <option  value="" selected="selected" >--Pilih / Choose--</option>
								<? 
								    $vSQL="select * from m_level_korwil order by fidsys";
								    $db->query($vSQL);
								    while ($db->next_record()) {
								?>                               
                          ...
                          <div class="divtr col-lg-6" >
                                <label   for="tfNama">
								Nama <? if($_GET['j']=='sub') echo 'Sub '?>Korwil*</label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-user"></i></span>
 ...
 <div class="col-md-5 col-lg-6 divtr" >
                                      <label for="exampleInputEmail1">
									  <span style="font-weight:bold">&nbsp;Atasan / Korwil Induk*</span></label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-gift"></i></span>
                                 <select class="form-control m-bot15" id="fidupline" name="fidupline" <? if ($vLevelL=='KOR') echo 'disabled';?>>
                                <option  value="" selected="selected" >--Pilih / Choose--</option>
								<? 
								    $vSQL="select * from m_korwil where flevel='KOR' and fidkorwil <> '$vUserActive' order by fidkorwil";
								    $db->query($vSQL);
								    while ($db->next_record()) {
								?>                               
