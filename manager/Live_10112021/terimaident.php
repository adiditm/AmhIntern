...
//print_r($_FILES);
 // $_SESSION['Ref']='';
	...
	$vPropL = $dbL->f('fprop');
	$vKotaL = $dbL->f('fkota');
	$vIdentL = $dbL->f('fcheckident');
	$vArrIdentL = json_decode($vIdentL,true);
...
function generateRandomString($length = 6) {
   ...
   if ($_POST['hPost'] != '1') {
	 ...
	 $oSystem->smtpmailer('japri_s@yahoo.com',$vMailFrom,'AMH',"Registrasi AMH Internal",'','',false);
	  ...
	  $vhSubTot=0;	  	 
		 ...
		 foreach($vPost as $key=>$val) {
			   if (preg_match("/fident/",$key)) {
				    $vArrIdent[$key] = $val;  
			   }
		 }
		 $vIdentJSON = json_encode($vArrIdent,1);
		// print_r($vBawaJSON);
	
		 $fdoc = $_FILES['fcheckidentdoc']['name'];
		 $tmp_name = $_FILES['fcheckidentdoc']['tmp_name'];
		 $vLowName = strtolower($oMember->getMemberName($fidmember));
		 $vLowName = str_replace(" ","_",$vLowName);
		 $vFileName = "fileident/ident-$fidmember-$vLowName".".pdf";
		...
		// print_r($_POST);		  
			 if ($oMember->updPilgrimsIdent($fidmember,  $vIdentJSON,$vFileName,$db)==1) {  
	...
	if($db->query('COMMIT;')) {	  
	   $oSystem->jsAlert("Update kelengkapan identitas sukses untuk ID Jamaah $fidmember!");	
...
//$('.year').css("max-width", "90px");*/
 ...
 // $.validator.messages.required = '<span style="color:red;font-weight:normal">This field is required!</span>';
  ...
  $('#frmReg input, #frmReg textarea,  #frmReg select, #frmReg checkbox, #frmReg radio').not([type="submit"]).not($("#fidmember")).not($("#fidentfoto34")).not($("#fidentfoto46")).not($("#fidentformas")).not($("#fidentformfc")).not($("#fidentakteas")).not($("#fidentaktefc")).not($("#fidentpasporas")).not($("#fidentpasporfc")).not($("#fidentktpas")).not($("#fidentktpfc")).not($("#fidentkkas")).not($("#fidentkkfc")).not($("#fidentnikahas")).not($("#fidentnikahfc")).not($("#fcheckidentdoc")).addClass('required');  
...
function removeSpecChar(e) {
 ...
 <div class="right_col" role="main">
		...
		<div><label>
		<h3> Tanda Terima Kelengkapan Identitas</h3></label></div> 



<form method="post" id="frmReg" name="frmReg" action="printident.php?uMemberId=<?=$vUserActive?>" target="_ident" enctype="multipart/form-data" >
		...
		<div class="divtr col-lg-12" >
             ...
             <? if (true) { ?>               				   
				...
				<div class="col-lg-6 col-md-6 divtr" >
				   <label   for="tfNama">Kelengkapan Identitas dan Jumlah</label>
                                    <div class="col-lg-12">
                                     <div class="row">   <input name="fidentfoto34"  id="fidentfoto34" type="checkbox" value="1" <? if ($vArrIdentL['fidentfoto34']=='1') echo 'checked'; ?>> 
                                     Foto 3x4 
                                       <input name="tfidentfoto34" type="text" value="1" size="4">
                                     </div>
                                       <div class="row"> <input name="fidentfoto46"  id="fidentfoto46" type="checkbox" value="1" <? if ($vArrIdentL['fidentfoto46']=='1') echo 'checked'; ?>>
                                       Foto 4x6
                                         <input name="tfidentfoto46" type="text" value="1" size="4">
                                       </div>
                                      <div class="row">  <input name="fidentformas"  id="fidentformas" type="checkbox" value="1" <? if ($vArrIdentL['fidentformas']=='1') echo 'checked'; ?>> 
                                      Formulir Asli 
                                        <input name="tfidentformas" type="text" value="1" size="4">
                                      </div>
                                     <div class="row">   <input name="fidentformfc"  id="fidentformfc" type="checkbox" value="1" <? if ($vArrIdentL['fidentformfc']=='1') echo 'checked'; ?>>
                                     Formulir Fotocopy 
                                       <input name="tfidentformfc" type="text" value="1" size="4">
                                     </div>
                                      
 <div class="row">  <input name="fidentakteas"  id="fidentakteas" type="checkbox" value="1" <? if ($vArrIdentL['fidentakteas']=='1') echo 'checked'; ?>> 
                                      Akte Lahir Asli 
                                        <input name="tfidentakteas" type="text" value="1" size="4">
 </div>  
<div class="row">  <input name="fidentaktefc"  id="fidentaktefc" type="checkbox" value="1" <? if ($vArrIdentL['fidentaktefc']=='1') echo 'checked'; ?>> 
                                      Akte Lahir Fotocopy 
                                        <input name="tfidentaktefc" type="text" value="1" size="4">
</div>                                                                           
 <div class="row">  <input name="fidentpasporas"  id="fidentpasporas" type="checkbox" value="1" <? if ($vArrIdentL['fidentpasporas']=='1') echo 'checked'; ?>> 
                                      Paspor Asli 
                                        <input name="tfidentpasporas" type="text" value="1" size="4">
 </div>   
<div class="row">  <input name="fidentpasporfc"  id="fidentpasporfc" type="checkbox" value="1" <? if ($vArrIdentL['fidentpasporfc']=='1') echo 'checked'; ?>> 
                                      Paspor Fotocopy 
                                        <input name="tfidentpasporfc" type="text" value="1" size="4">
</div>                          </div>                                                  
                </div>

                          <div class="divtr col-lg-6">
                                   <label   for="tfNama">&nbsp;&nbsp;</label>
										<div class="col-lg-12">
                                    	<div class="row">  <input name="fidentktpas"  id="fidentktpas" type="checkbox" value="1" <? if ($vArrIdentL['fidentktpas']=='1') echo 'checked'; ?>> 
                                    	KTP Asli 
                                    	  <input name="tfidentktpas" type="text" value="1" size="4">
                                    	</div>
                                        <div class="row">   
                                          <input name="fidentktpfc"  id="fidentktpfc" type="checkbox" value="1" <? if ($vArrIdentL['fidentktpfc']=='1') echo 'checked'; ?>>
                                        KTP Fotocopy 
                                        <input name="tfidentktpfc" type="text" value="1" size="4">
                                        </div>
                                        <div class="row">  <input name="fidentkkas"  id="fidentkkas" type="checkbox" value="1" <? if ($vArrIdentL['fidentkkas']=='1') echo 'checked'; ?>> 
                                        KK Asli
                                           <input name="tfidentkkas" type="text" value="1" size="4">
                                        </div>
                                        <div class="row">  <input name="fidentkkfc"  id="fidentkkfc" type="checkbox" value="1" <? if ($vArrIdentL['fidentkkfc']=='1') echo 'checked'; ?>> 
                                        KK Fotocopy 
                                          <input name="tfidentkkfc" type="text" value="1" size="4">
                                        </div>
                                       
<div class="row">  <input name="fidentnikahas"  id="fidentnikahas" type="checkbox" value="1" <? if ($vArrIdentL['fidentnikahas']=='1') echo 'checked'; ?>> 
                                      Buku Nikah Asli 
                                        <input name="tfidentnikahas" type="text" value="1" size="4">
</div>
<div class="row">  <input name="fidentnikahfc"  id="fidentnikahfc" type="checkbox" value="1" <? if ($vArrIdentL['fidentnikahfc']=='1') echo 'checked'; ?>> 
                                     Buku Nikah Fotocopy 
                                       <input name="tfidentnikahfc" type="text" value="1" size="4">
</div>                                                                                  
								 </div>
                           </div>
      <? } ?>
...
<? if (preg_match("/listregooo.php/",$vRefer) || preg_match("/aktif.php/",$vRefer)) {?>
                                        <button id="btnSubmit" type="button" class="btn btn-info"  onClick="printIdent(this)">Print Tanda Terima </button> <div id="divLoad" style="display:inline">
										<? } ?>
