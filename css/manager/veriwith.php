...
-->
  ...
  <div class="right_col" role="main">
    <label> </label>
    <h3>Approval Withdrawal Bonus</h3>
          ...
          <td height="5" align="left" valign="top">
            ...
            <form id="demoform" name="demoform" method="post" action="" >
              ...
              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="table table-striped table-bordered">
                <tr>
                  ...
                  <td align="center" width="30" nowrap="nowrap" valign="middle"><strong><span style="font-family:Arial; font-size:10.0pt; ">ID Withdraw </span></strong></td>
                  ...
                  <td align="center" width="20" nowrap="nowrap" valign="middle"><strong>Total Withdraw </strong></td>
			...
			?>
                <tr>
                  ...
                  <td width="30" valign="middle" nowrap="nowrap"><div align="left"><span style="font-family:Verdana; font-size:10px">
                      <?=$oPhpdate->YMD2DMY($vTgl,"-")?>
                      </span></div></td>
                  <td width="30" valign="middle" nowrap="nowrap"><div align="left">
                      <?=$vIDJual?>
                    </div></td>
                  <td width="30" nowrap="nowrap" valign="middle"><div align="left">
                      <?=$vUserID?>
                    </div></td>
                  <td width="40" nowrap="nowrap" valign="middle"><?=$oMember->getMemberName($vUserID)?></td>
                  <td align="right" width="15" nowrap="nowrap" valign="middle"><?=$vCurr?>
                    <?=number_format($vSubtotal,0,",",".")?></td>
                  <td width="105" nowrap="nowrap" valign="middle"><?=$oMember->getBankName($db->f('frekto'))?>
                    ,
                    <?=$oMember->getMemField('fnorekening',$vUserID)?></td>
                  <td width="30" nowrap="nowrap" valign="middle"><?=$vProctext?></td>
                  <td width="79" nowrap="nowrap" valign="middle"><p class="MsoNormal style4">
                      <input class="btn btn-primary btn-xs" type="button" name="Button" onClick="doProcess('processwd.php?uIDJual=<?=$vIDJual?>&uSess=<?=md5('jalanku')?>&uUserID=<?=$vUserID?>');" value="Process" <? if ($vProcessed==2 || $vProcessed==4) echo "disabled";?> />
                      <input class="btn btn-default btn-xs" type="button" name="Button2" onclick="doCancel('processwd.php?uIDJual=<?=$vIDJual?>&uSess=<?=md5('jalanku')?>&uCanc=<?=md5('bataldeh')?>&uUserID=<?=$vUserID?>');" value="Cancel" <? if ($vProcessed==2 || $vProcessed==4) echo "disabled";?> />
                      <input class="btn btn-success btn-xs" name="btnDetail" type="button" id="btnDetail" onclick="doDetail('<?=$vIDJual?>');" value="Detail"  />
                    </p></td>
                </tr>
                <? } ?>
                <tr>
                  <td nowrap="nowrap" colspan="5" valign="middle"><div align="left"><strong><span style="font-family:Arial; font-size:10.0pt; ">Total Withdrawal (halaman ini - Verified) </span></strong></div></td>
                  <td nowrap="nowrap" valign="middle"><div align="right"><strong><span style="font-family:Verdana;font-size:10px">
                ...
                <tr>
                  <td nowrap="nowrap" colspan="5" valign="middle"><div align="left"><strong><span style="font-family:Arial; font-size:10.0pt; ">Total Withdrawal (halaman ini - All) </span></strong></div></td>
                  <td nowrap="nowrap" valign="middle"><div align="right"><strong><span style="font-family:Verdana;font-size:10px">
                ...
                <tr>
                  <td nowrap="nowrap" colspan="5" valign="middle"><div align="left"><span style="text-align:left;"><strong><span style="font-family:Arial; font-size:10.0pt; ">Total Withdrawal (Verified) </span></strong></span></div></td>
                  <td nowrap="nowrap" valign="middle"><div align="right"><strong><span style="font-family:Verdana;font-size:10px">
                ...
                <tr>
                  <td nowrap="nowrap" colspan="5" valign="middle"><p align="justify" style="text-align:left;"><strong><span style="font-family:Arial; font-size:10.0pt; ">Total Withdrawal (All) </span></strong></p></td>
                  <td width="94" nowrap="nowrap" valign="middle"><p align="right"><strong><span style="font-family:Verdana;font-size:10px">
