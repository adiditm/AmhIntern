    ...
    <div class="table-responsive">
        <table width="100%" border="0" class="table table-striped table-bordered" id="tblMain">
          ...
          <tr id="tr<?=$vIdSys?>">
            ...
            <td id="tdstat<?=$vIdSys?>" class=""><input  id="btnPay<?=$vIdSys?>" name="btnPay<?=$vIdSys?>" type="button" class="btn btn-info btn-xs" value="Tandai Terbayar" onClick="setPay('<?=$vIdSys?>','<?=addslashes($vRemark)?>')" <? if ($vStatPay=='1') echo 'disabled'; ?>></td>
            </tr>
           <? } ?>
          <tr class="hide">
            <td style="width: 5%" >&nbsp;</td>
