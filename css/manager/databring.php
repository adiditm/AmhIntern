             ...
             <? if ($dbL->f('fsex')=='F') { ?>               				   
				...
				<div class="col-lg-6 col-md-6 divtr" >
				   <label   for="tfNama">Barang Bawaan</label>
                                    <div class="col-lg-12">
                                     <div class="row">   <input name="fbawakoper"  id="fbawakoper" type="checkbox" value="1" <? if ($vArrBringL['fbawakoper']=='1') echo 'checked'; ?>> Tas Koper</div>
                                       <div class="row"> <input name="fbawatpaspor"  id="fbawatpaspor" type="checkbox" value="1" <? if ($vArrBringL['fbawatpaspor']=='1') echo 'checked'; ?>> Tas Passport</div>
                                      <div class="row">  <input name="fbawabukudoa"  id="fbawabukudoa" type="checkbox" value="1" <? if ($vArrBringL['fbawabukudoa']=='1') echo 'checked'; ?>> Buku Doa</div>
                                     <div class="row">   <input name="fbawabergok"  id="fbawabergok" type="checkbox" value="1" <? if ($vArrBringL['fbawabergok']=='1') echo 'checked'; ?>> Bergo Kecil</div>
                                      </div>  
                </div>
                          ...
                          <div class="divtr col-lg-6">
                                   <label   for="tfNama">&nbsp;&nbsp;</label>
										<div class="col-lg-12">
                                    	<div class="row">  <input name="fbawatkabin"  id="fbawatkabin" type="checkbox" value="1" <? if ($vArrBringL['fbawatkabin']=='1') echo 'checked'; ?>> Tas Kabin</div>
                                        <div class="row">  <input name="fbawakainser"  id="fbawakainser" type="checkbox" value="1" <? if ($vArrBringL['fbawakainser']=='1') echo 'checked'; ?>> Kain Seragam </div>
                                        <div class="row">  <input name="fbawabergob"  id="fbawabergob" type="checkbox" value="1" <? if ($vArrBringL['fbawabergob']=='1') echo 'checked'; ?>> Bergo Besar</div>
                                        <div class="row">  <input name="fbawalain"  id="fbawalain" type="checkbox" value="1" <? if ($vArrBringL['fbawalain']=='1') echo 'checked'; ?>> Lainnya  </div>
                                        </div>
				   ...
				   <label   for="tfNama">Barang Bawaan</label>
                                    <div class="col-lg-12">
                                     <div class="row">   <input name="fbawakoper"  id="fbawakoper" type="checkbox" value="1" <? if ($vArrBringL['fbawakoper']=='1') echo 'checked'; ?>> Tas Koper</div>
                                       <div class="row"> <input name="fbawatpaspor"  id="fbawatpaspor" type="checkbox" value="1" <? if ($vArrBringL['fbawatpaspor']=='1') echo 'checked'; ?>> Tas Passport</div>
                                      <div class="row">  <input name="fbawabukudoa"  id="fbawabukudoa" type="checkbox" value="1" <? if ($vArrBringL['fbawabukudoa']=='1') echo 'checked'; ?>> Buku Doa</div>
                                     <div class="row">   <input name="fbawaikrom"  id="fbawaikrom" type="checkbox" value="1" <? if ($vArrBringL['fbawaikrom']=='1') echo 'checked'; ?>> Kain Ikrom</div>
                                      </div>  
                </div>
                          ...
                          <div class="divtr col-lg-6">
                                   <label   for="tfNama">&nbsp;&nbsp;</label>
                                    	...
                                    	<div class="row">  <input name="fbawatkabin"  id="fbawatkabin" type="checkbox" value="1" <? if ($vArrBringL['fbawatkabin']=='1') echo 'checked'; ?>> Tas Kabin</div>
                                        <div class="row">  <input name="fbawakainser"  id="fbawakainser" type="checkbox" value="1" <? if ($vArrBringL['fbawakainser']=='1') echo 'checked'; ?>> Kain Seragam </div>
                                        <div class="row">  <input name="fbawasabuk"  id="fbawasabuk" type="checkbox" value="1" <? if ($vArrBringL['fbawasabuk']=='1') echo 'checked'; ?>> Sabuk</div>
                                        <div class="row">  <input name="fbawalain"  id="fbawalain" type="checkbox" value="1" <? if ($vArrBringL['fbawalain']=='1') echo 'checked'; ?>> Lainnya  </div>
                                        </div>
                                  ...
                                  <label for="exampleInputEmail1" >Tanda Terima (Satu file PDF)  </label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-paperclip"></i></span>
                                         <input onBlur="" onChange=""  id="fbringdoc" name="fbringdoc" class="form-control " placholder="Satu File PDF"   type="file" value=""  >
                                    </div>
</div>
