<? 
 ...
 if ($vSearch!="")	{	
  ...
  $vSQL="select count(*) as fjumrec from tb_mutasi where fkind in ('ktp','spon','reg','withdraw','transin','transout') and fidmember='$vUserChoosed' $vCrit";
...
<br>
        ...
        <?
			    ...
			    $vSQL="select * from tb_mutasi where   fkind in ('ktp','spon','reg','withdraw','transin','transout') and fidmember='$vUserChoosed' ";
				...
				if ($vIdSys=='') $vIdSys=0;
				 ...
				 $vSQLOpBal="select sum(fcredit-fdebit) as fopbal from tb_mutasi where  fidmember='$vUserChoosed'  and fidsys < '$vIdSys1st' and fkind in ('ktp','spon','reg','withdraw','transin','transout')";				
