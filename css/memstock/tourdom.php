...
<style type="text/css">
  ...
  echo  $vSQL="select * from m_tour where fstatusrow=1 and fgroup='d'  $vAnd order by fcountry";
   $db->query($vSQL);
...
<?
   $vSQL="select * from m_tour where fstatusrow=1  and fgroup='d'  $vAnd order by fcountry";
