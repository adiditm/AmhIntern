   ...
   // @mail("a_didit_m@yahoo.com","Entri RO Spectra by $vUser",print_r($_POST,true)."\n\n\n".print_r($_SESSION['save'],true));
	...
	$vTotal=$_POST['hTotal'];
        ...
        //print_r($val);
    	 ...
    	 $vSQL.=" values('$vNextJual','$vSeller','$vBuyer','$vUser','$lmAngs',".round($tfPoin,2).",$vPoinFund, ".round($vTotal,2).",now(),'POIN',0,'$lmMethod','Pembayaran  $hPayText',now(),'1','1981-01-01 00:00:00')";
  	 	//echo $vSQL;
  	 	$db->query($vSQL);
  	 	$vTotItem+=$val['txtJml'];
