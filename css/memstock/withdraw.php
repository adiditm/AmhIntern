...
function saveWithdraw() {
	...
	if  (document.getElementById('hPending'))
    		vPending = document.getElementById('hPending').value;
...
//   alert(vAll);
	if ((parseFloat(vWD) + parseFloat(vPending)) > parseFloat(vSaldoX)) {
		alert('Jumlah withdraw '+vWD+' tidak boleh melebihi saldo '+vSaldoX+' (termasuk Issued & Withdraw yang pending ('+vPending+')');
		return false;
	} 
  ...
  <div class="right_col" role="main">
		<div><label>
		<h3>Withdrawal Bonus</h3></label></div>  		
              ...
              <div class="row">
                  ...
                  <div class="col-lg-6">
                   <label>Saldo</label>
                    ...
                    <input name="saldo" type="text" value="<?=$oMember->getSaldoAdm($vUser,$vJenis)?>" readonly="true" class="form-control">
                    <input name="hAction" type="hidden" id="hAction" value="fPost"> 
...
&nbsp;
     ...
     <div class="table-responsive">
      ...
      <tr <? if ($vProcessed==2) echo "bgcolor='#CCCCCC'" ?> >
                ...
                <td width="18%"><div align="center" class="style9">No Withdraw </div></td>
                <td width="18%"><div align="center" class="style10"><strong>Nilai Withdraw </strong></div>
              ...
              <?
		  $vsql="select fadmin,ftglupdate,ftglappv,fidwithdraw,fidmember,frekto,fnominal as asubtotal,fstatusrow, fket, fnoteadm from tb_withdraw where 1 and fidmember='$vUser' and date(ftglupdate) between  date('$vsTglAwal') and date('$vsTglAkhir')";
		  $vsql.=$vCrit;
...
<script language="javascript">
   <? if($vPriv=='administrator') { ?>
   		alert('Withdrawal hanya boleh dilakukan oleh Korwil/Subkorwil atau Pebisnis!');
