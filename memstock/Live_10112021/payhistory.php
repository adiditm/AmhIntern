<? 
 ...
 if ($vSearch!="")	{	
  ...
  $vSQL="select count(*) as fjumrec from tb_payhist where fkind in('sawal','angs1','angs2','angs3','angs4','flunas') and fidmember='$vUserChoosed' $vCrit";
...
<br>
        ...
        <?
			    ...
			    $vSQL="select * from tb_payhist where   fkind in('fstorawal','fangsur1','fangsur2','fangsur3','fangsur4','flunas') and fidmember='$vUserChoosed'   ";
