...
/*  if (isset($vRefUser))
 ...
 if ($vSearch!="")	{	
  ...
  $vSQL="select count(*) as fjumrec from tb_mutasi where fkind in ('ktp','spon','reg','withdraw','transin','transout','trans','trxpulsa','trans') and fidmember='$vUserChoosed' $vCrit";
            ...
            <div align="left" class="col-sm-6 col-md-6 col-xs-6">
              ...
              <select name="lmKor" id="lmKor" class="form-control">
				...
				<?
				   ...
				   $vSQL="select fidmember, fnama from m_pebisnis where faktif='1' $vAndSP ";
				   $vSQL .= " union ";
...
<br>
        ...
        <?
			    ...
			    $vSQL="select * from tb_mutasi where   fkind in ('ktp','spon','reg','withdraw','transin','transout','trans','trxpulsa','trans') and fidmember='$vUserChoosed' ";
				...
				if ($vIdSys=='') $vIdSys=0;
				 ...
				 $vSQLOpBal="select sum(fcredit-fdebit) as fopbal from tb_mutasi where  fidmember='$vUserChoosed'  and fidsys < '$vIdSys1st' and fkind in ('ktp','spon','reg','withdraw','transin','transout','trxpulsa','trans')";				
