   ...
   // @mail("a_didit_m@yahoo.com","Entri RO Spectra by $vUser",print_r($_POST,true)."\n\n\n".print_r($_SESSION['save'],true));
    ...
    while (list($key,$val) = each($_SESSION['save'])) {
     ...
     if ($lmMethod=='wpr')
	 {
		...
		$oSystem->jsLocation("../memstock/etaprod.php");
		exit;
	 }
...
circle btn-success btn-scroll-to-top fade" data-click="scroll-top"><i class="fa fa-angle-up"></i></a>
		<!-- end scroll to top btn -->
	</div>
	<!-- end page container -->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" id="btClose" name="btClose" class="btn bt
