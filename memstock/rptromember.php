...
if ($vSort =='T')
   ...
   $vOrder.=" order by sum(a.fsubtotal) desc ";
			 ...
			 $vsql="select  distinct date(a.ftanggal) as ftang,a.fidseller,a.fidmember,a.fidpenjualan,sum(a.fsubtotal) as ftot from tb_penjualan a,m_anggota b where a.fidmember=b.fidmember  and a.fjenis='RO' $vCrit group by date(a.ftanggal),a.fidseller,a.fidmember,a.fidpenjualan"; 
    ...
    <div class="table-responsive">
        <table border="0" class="table table-striped" style="width:98%">
          ...
          <? 
             ...
             $vNo=0;
			 $vsql="select  distinct date(a.ftanggal) as ftang,a.fidseller,a.fidmember,a.fidpenjualan,sum(a.fsubtotal) as ftot from tb_penjualan a,m_anggota b where a.fidmember=b.fidmember  and fjenis='RO' $vCrit group by date(a.ftanggal),a.fidseller,a.fidmember,a.fidpenjualan"; 
			// $vsql.=$vCrit;
