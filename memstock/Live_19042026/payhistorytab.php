<? 
 ...
 if ($vSearch!="")	{	
  ...
  $vSQL="select count(*) as fjumrec from tb_payhisttab where fkind in('sawal','angs1','angs2','angs3','angs4','flunas') and fidmember='$vUserChoosed' $vCrit";
...
<div class="right_col" role="main">
		...
		<div><label>
		<h3>History Pembayaran Tabungan <?=$vRefUser." / ".$oMember->getMemFieldTab('fnama',$vRefUser);?></h3></label></div>  		       
...
<br>
        ...
        <?
			    ...
			    $vSQL="select * from tb_payhisttab where   fkind in('sawal','angs1','angs2','angs3','angs4','lunas') and fidmember='$vUserChoosed'   ";
