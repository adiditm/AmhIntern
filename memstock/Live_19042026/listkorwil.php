...
left join m_admin c on b.fidkorwil=c.fkorwil
where c.fidmember='$vUser' ";
...
$vsql="select * from m_anggota where concat(fprop,fkota,fkec) in ($vSQLArea) ";
...
*/
	...
	<div class="right_col" role="main">
		...
		<div><label>
		<h3>Daftar Jamaah di <? if ($vLevel=='SUBKOR') echo 'Sub'; ?> Korwil <?=$_SESSION['LoginUser']?></h3></label></div>
...
<div align="left" class="table-responsive col-lg-6" style="min-height:270px" > 
		  ...
		  <table border="0" cellpadding="4" cellspacing="0"  align="left" >
            ...
            <tr>
              <td height="25" style="width: 14%" ><div align="left">ID Registrasi </div></td>
  ...
  <tr >
            ...
            <tr>
              ...
              <td colspan="2"><div align="left"><br>
                ...
                <input name="Submit2" type="button" class="btn btn-default" value="Reset"  onClick="document.location.href='../memstock/listkorwil.php?op=&current=mdm_korwil_sub&menu=mdm_korwil_sublistkor'"/>
...
<form name="memberForm">
    ...
    <table width="100%" border="0" align="left" cellpadding="1" cellspacing="0" class="table" style="background-color:white" >
      ...
      <tr style="color:;font-weight:bold"> 
        ...
        <td width="73"  height="26" style="width: 30px"> <div align="center" >ID Registrasi </div></td>
		...
		<td width="268"><div align="center" > Tgl Berangkat</div></td>
...
<ul class="pagination" >
   ...
   for ($i=0;$i<$vPageCount;$i++) {
     ...
     if ($idisp!=$vPage) {
?>
              <li ><a  href="listkorwil.php?lmAktif=<?=$vAktif?>&lmMship=<?=$vPrem?>&uPage=<?=$idisp?>&lmSort=<?=$vSort?>&current=<?=$_REQUEST['current']?>" >
              <?=$i+1?>
              </a> </li> 
              <?
  } else {
