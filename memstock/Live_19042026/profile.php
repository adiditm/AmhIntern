...
<div class="col-lg-6 col-md-6 divtr hide">
  								...
  								<div class="col-lg-6 col-md-6 divtr">
													<label for="exampleInputEmail1">Referensi Username* <div align="left" style="display:inline" id="statKitSpon"></div></label>
					                 <div class="input-group">
                                      <span class="input-group-addon">  <i class="fa fa-user"></i></span>
					                            ...
					                            <div class="col-lg-6 col-md-6 divtr"> <label for="exampleInputEmail1">Referensi Name*</label>
					                                 <div class="input-group">
					                                    <span class="input-group-addon">  <i class="fa fa-user"></i></span>
			                    ...
			                    <div class="panel panel-default hide" id="panelkanan">
					                    <div class="panel-heading" >
					                             <div class="panel-title" style="margin-top:-10px">
					        						 <label for="exampleInputEmail1" style="font-weight:bold;">Referensi 
													 Data</label>
					                               <br style="display: block;margin: -5px 0;" />                                    
					                     		</div>
					                     </div>
