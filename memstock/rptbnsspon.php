  ...
  <link rel="stylesheet" type="text/css" href="../js/bootstrap-datetimepicker/css/datetimepicker-custom.css" />
		...
		<div id="content" class="content">
			<ol class="breadcrumb pull-right">
				<h4><li><a href="javascript:;">Diskon Referensi</a></li></h4>
...
<br />    
    <table width="75%" border="0" align="center" cellpadding="0" cellspacing="0" class="table table-striped table-bordered">
        <tr style="font-weight:bold"> 
          ...
          <td width="34%" align="center" ><div align="right">Diskon  Referensi</div></td>
          <td width="46%" align="center"><div align="right">Jumlah Diskon</div></td>
        </tr>
        ...
        <tr >
          <td colspan="3" align="center"><div align="left" style="color:blue"><b>Catatan:</b> Diskon Referensi di halaman ini adalah nilai gross sebelum dialokasikan untuk Wallet Non Cash dan pajak</div></td>
        </tr>
      </table>
