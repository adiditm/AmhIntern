   ...
   // @mail("a_didit_m@yahoo.com","Entri RO Spectra by $vUser",print_r($_POST,true)."\n\n\n".print_r($_SESSION['save'],true));
    ...
    while (list($key,$val) = each($_SESSION['save'])) {
        //print_r($val);
    	 ...
    	 $vSQL="insert into $vMainTable(fidpenjualan, fidseller, fidmember, falamatkrm, fnostockist, fidproduk, fjumlah, ftanggal, fhargasat, fsubtotal, fsize, fcolor, ftgltrans, fjenis, fjmltrans, fserial, fpin, fmethod, fketerangan, ftglentry, fprocessed, ftglprocessed, fongkir)";
    	$vSQL.=" values('$vNextJual','$vSeller','$vBuyer','$vAlamat','$vUser','".$val['lmKode']."',".$val['txtJml'].",now(),".$val['hHarga'].",".$val['hSubTot'].",'".$val['lmSize']."','".$val['lmColor']."',now(),'RO',0,'','','$lmMethod','Repeat Order',now(),'2','1981-01-01 00:00:00',$vOngkir)";
...
<?
      $oSystem->jsLocation("//aminahku.com");
   }   
...
<div class="col-lg-6 col-md-6 divtr" >
		...
		<div class="col-lg-6 col-md-6 divtr" >
                                      ...
                                      <span class="input-group-addon"> <i class="fa fa-money"></i></span>
													<input  type="text" class="form-control" id="tfOngkir" name="tfOngkir" placeholder="Contoh: 30000 (tanpa titik/koma)" onChange="calcTot()" value="0">
												</div>
											</div>
...
<table class="table table-striped" >
      ...
      <div class="col-lg-6">
         ...
         <select name="lmBank" id="lmBank" class="form-control" disabled>
           ...
           <option value="Bank BCA 00000001">Bank BCA 00000001</option>
           <option value="Bank Mandiri 00000002">Bank MAndiri 00000002</option>
           <option value="Bank BNI 00000003">Bank BNI 00000003</option>
           <!-- <option value="wtr">Wallet Product + Cash / Transfer</option> -->
         </select>
       </div>       
       </div>									
