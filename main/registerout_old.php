	 ...
	 $oSystem->smtpmailer('japri_s@yahoo.com',$vMailFrom,'AMH',"Registrasi AMH Internal",'','',false);
	  ...
	  $vhSubTot=0;	  	 
		 ...
		 if ($vPriv=='administrator') {
			...
			$vSQL="update m_infodep set fsisaseat=fsisaseat-1 where ftgldepart='$ftgldepart'";
			$db->query($vSQL);
			...
			if ($fstorawal > 0) {
				   $vDesc = "Setoran Awal";
				   $oKomisi->insertPayment($fidmember,$fidmember,date("Y-m-d H:i:s"),$vDesc,$fstorawal,0,$fstorawal,'fstorawal') ;
			}
...
function getSeat(pDepart) {
  		...
  		var vURL="../main/mpurpose_ajax.php?op=getseat&depart="+pDepart;
...
function spreadPProg(pDepart,pProg,pPaket) {
  if (pPaket !='' && pProg!='' && pDepart!='') {
  		var vURL="../main/mpurpose_ajax.php?op=thepprog&ppaket="+pPaket+"&pprog="+pProg+'&depart='+pDepart;
		$.get(vURL,function(data){
			var vObj=$.parseJSON(data);
			if (vObj.status=='success') {
				//alert(vObj.data.price);
		   ...
		   $.post(vURL,postdata,function(ret){
			  ...
			  if(vObj.status=='xsuccessref') {
				 ...
				 // alert(vObj.message); 
				  ...
				  $('#fnoktprefer').val(vObj.data.noid);
			  } else {
...
<? } ?>
 ...
 <div class="right_col" role="main">
		...
		<div><label>
		<h3>Registrasi Jamaah <? if ($_GET['current']=='mdm_korwil_sub') echo " oleh Korwil / Sub Korwil";?> <?=$vMarkDev?></h3></label></div> 
...
<div class="col-md-5 col-lg-6 divtr" >
 ...
 <option value="">--Pilih Jenis--</option>
							                                ...
							                                <option value="U" selected>Umroh</option>

							                                <option value="H">Haji</option>
...
<div class="divtr col-lg-6">
                                ...
                                <option  value="" selected="selected" >--Pilih / Choose--</option>
								<? 
								    $vSQL="select * from m_infodep order by ftgldepart";
								    $db->query($vSQL);
								    while ($db->next_record()) {
								?>                               
...
<div class="divtr col-lg-12" style="display:none" id="divSeat">
                                  <label id="lblSeat" for="exampleInputEmail1" style="color:#00f">Keberangkatan: <span id="spDepart"></span>, <span id="spPlane"></span>, Sisa seat: <span id="spSisa">0</span><span id="spHotel"></span> </label>
...
<div class="col-md-5 col-lg-6 divtr" >
                                 ...
                                 <select class="form-control m-bot15" id="fpaket" name="fpaket" onChange="spreadPProg($('#ftgldepart').val(),$('#fprogram').val(),this.value)">
                                <option  value="" selected="selected" >--Pilih / Choose--</option>
								<? 
...
<div class="col-md-5 col-lg-6 divtr" id="divProg" >
                            ...
                            <select class="form-control m-bot15" id="fprogram" name="fprogram" onChange="spreadPProg($('#ftgldepart').val(),this.value,$('#fpaket').val())">
                            <option  value="" selected="selected" >--Pilih / Choose--</option>
                                <?
...
<div class="col-md-5 col-lg-12 divtr " id="divPromo" style="display:none">
                          ...
                          <div style="" class=" divtr col-lg-6">
							...
							<label for="exampleInputEmail1">Jumlah Hari* <div align="left" style="display:inline" id="statKitHari"></div></label>
...
<div class="divtr col-lg-12" >
								...
								Nama Lengkap Calon Pebisnis*</label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-user"></i></span>
                                <input type="text" class="form-control" id="fnamabuss" name="fnamabuss" placeholder="(Tanpa tanda koma)*" onBlur="this.value=this.value.replace(/,/g,'');" onKeyUp="this.value=this.value.replace(/,/g,'');" value="-">
                                </div>
</div>		
...
<div class="divtr col-lg-6" >
								...
								Nomor HP Calon Pebisnis*</label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-mobile"></i></span>
                                <input type="text" class="form-control" id="fnohpbuss" name="fnohpbuss" placeholder="" onBlur="this.value=this.value.replace(/,/g,'');" onKeyUp="this.value=this.value.replace(/,/g,'');" value="-">
                                </div>
</div>		
...
<div class="divtr col-lg-6" >
								...
								Ahli Waris*</label>
                                    <div class="input-group">
                                      <span class="input-group-addon"> <i class="fa fa-user"></i></span>
                                <input type="text" class="form-control" id="fwarisbuss" name="fwarisbuss" placeholder="" onBlur="" onKeyUp="" value="-">
                                </div>
</div>
...
<div style="" class=" divtr col-lg-12">
							...
							<label for="exampleInputEmail1">Pebisnis* <div align="left" style="display:inline" id="statKitPres"></div></label>
                                   ...
                                   <input type="text" class="form-control" id="frefer" name="frefer" placeholder="Masukkan Kode Pebisnis" value="<?=$vRef?>" readonly onBlur="spreadRef(this)" onChange=""  >
