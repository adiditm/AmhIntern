...
// Get signature
 $signatureAll = $oActionPay->getSignature($clientId, $clientSecret, $apiSecret, $data_inquiry);
  ...
  echo "Client Secrets: ".$clientId.":".$clientSecret.":".$apiSecret."<br>";
echo "Response Get Signature: ".$signature."<br>";
//  echo "Sig: $signature <br>";
// Example usage
 $accessToken = $oActionPay->getAuthToken($clientId, $clientSecret);

echo "Payload Get Token: ".$data_inquiry."<br>";
echo "Response Get Token: ".$accessToken."<br>";
...
echo "Withdraw Payload: <br>";
print_r($data_inquiry);

echo "Withdraw Confirm Response: <br>";
