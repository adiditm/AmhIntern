...
$vsql="select * from m_korwil where 1 ";
...
<div class="row" style="text-align:left">
  ...
  <? if ($vCurrent=='mdm_master_data') { ?>      
       <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_detail")) { ?> <input alt="Detail / Verifikasi Data" name="btDAddKor" type="button" class="btn btn-success btn-sm" id="btDAddKor" onClick="return MM_goToURL('parent','../manager/addkorwil.php?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Tambah Korwil &raquo;" onMouseovers="showhint('Lihat detail /  Edit Member '+getValue(), this, event, '220px')" style="margin-top:5px" >  <? } ?> 
...
<? if ($vCurrent=='mdm_master_data') { ?>      
 ...
 <? if ($vCurrent=='mdm_master_data') { ?>      
       <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_detail")) { ?> <input alt="Detail / Verifikasi Data" name="btDetail3" type="button" class="btn btn-success btn-sm" id="btDetail3" onClick="return MM_goToURL('parent','../manager/regkorwil.php?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uMemberId='+getValue());return document.MM_returnValue" value="Detail / Verifikasi Data &raquo;" onMouseovers="showhint('Lihat detail /  Edit Member '+getValue(), this, event, '220px')" style="margin-top:5px" >  <? } ?>        
