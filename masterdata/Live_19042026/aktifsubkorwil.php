...
<div class="row" style="text-align:left">
  ...
  <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_uwallet")) { ?><input name="btRegis" type="button" class="btn btn-success btn-sm" id="btRegis" onClick="return MM_goToURL('parent','../memstock/listregdirect.php?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uRegistrar='+getValue());return document.MM_returnValue" value="Jamaah yg Didaftarkan&raquo;" onMouseovers="showhint('Nex-Wallet '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?> 
    
     <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_uwallet")) { ?><input name="btWilayah" type="button" class="btn btn-success btn-sm" id="btWilayah" onClick="return MM_goToURL('parent','../memstock/listktpdirect.php?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uRegistrar='+getValue());return document.MM_returnValue" value="Jamaah di Area&raquo;" onMouseovers="showhint('Nex-Wallet '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?> 
...
<? if ($vCurrent=='mdm_master_data') { ?>      
 ...
 ?>
  ...
  <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_uwallet")) { ?><input name="btRegis1" type="button" class="btn btn-success btn-sm" id="btRegis1" onClick="return MM_goToURL('parent','../memstock/listregdirect.php?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uRegistrar='+getValue());return document.MM_returnValue" value="Jamaah yg Didaftarkan&raquo;" onMouseovers="showhint('Nex-Wallet '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?> 
 
  <? if (true || $oSystem->checkPriv($vUser,"mdm_listprof_uwallet")) { ?><input name="btWilayah1" type="button" class="btn btn-success btn-sm" id="btWilayah1" onClick="return MM_goToURL('parent','../memstock/listktpdirect.php?current=<?=$vCurrent?>&op=<?=$vSpy?>'+CryptoJS.MD5(getValue().trim())+'&uRegistrar='+getValue());return document.MM_returnValue" value="Jamaah di Area&raquo;" onMouseovers="showhint('Nex-Wallet '+getValue(), this, event, '210px')" style="margin-top:5px" /> <? } ?> 
...
<ul class="pagination" >
   ...
   for ($i=0;$i<$vPageCount;$i++) {
     ...
     if ($idisp!=$vPage) {
?>
              <li ><a  href="aktifsubkorwil.php?lmAktif=<?=$vAktif?>&lmMship=<?=$vPrem?>&uPage=<?=$idisp?>&lmSort=<?=$vSort?>&current=<?=$_REQUEST['current']?>" >
              <?=$i+1?>
              </a> </li> 
              <?
  } else {
