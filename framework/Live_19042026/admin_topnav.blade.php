              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="">
                  ...
                  <!--  <li><a href="../masterdata/madmin.php"> Profile</a></li>
                    ...
                    <li style="width:100%"><a href="../memstock/ewalletbal.php" style="white-space:nowrap" href="javascript:;">Saldo <br><font color="#00f">[ID: <?=$vIDSal ?>] : <?=number_format($vSaldo,0,",","."); if (($vSaldo - $vEndap) >0) { ?> (Aktif: <?=number_format($vSaldo - $vEndap,0,",",".")?>) <? } else {?> (Aktif: <?=number_format(0,0,",",".")?>) <? } ?></font></a></li> 
                   <input type="hidden" id="hSaldoG" name="hSaldoG" value="<?=(int) ($vSaldo - $vEndap)?>"  />
                   <? if ($vJenis=='seller') {?>
                   		<li><a href="../manager/regseller.php?id=<?=base64_encode(strtolower(trim($vUser)))?>"><i class="fa fa-user pull-right"></i> Profile</a></li>
                   <? } ?>
