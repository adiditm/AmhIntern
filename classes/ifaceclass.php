...
//get Deskripsi menu
    function getKetTRX($pMenu) {
	    global $oDB;
		$vsql="select ftext1 from tb_trxtext where fmenuid='$pMenu'";
		$oDB->query($vsql);
		while ($oDB->next_record()) {
		   $vres=$oDB->f('ftext1');
		}
...
//get Wilayah
    function getWilayah($pWil,$pKdProp,$pKdKab,$pKdKec) {
	    global $oDB;
		if ($pWil=='prop')
		   $vsql="select fkdprop,fkdkab,fkdkec,fwilayah from m_wilayah where fkdprop='$pKdProp' and fkdkab=0 and fkdkec=0";
		else if ($pWil=='kab')   
		   $vsql="select fkdprop,fkdkab,fkdkec,fwilayah from m_wilayah where fkdprop='$pKdProp' and fkdkab='$pKdKab' and fkdkec=0";
		else if ($pWil=='kec')   
		   $vsql="select fkdprop,fkdkab,fkdkec,fwilayah from m_wilayah where fkdprop='$pKdProp' and fkdkab='$pKdKab' and fkdkec='$pKdKec'";
