...
//Ambil saldo
	function getSaldoAdm($pId,$pJenis) {
			 ...
			 if ($pJenis=='sponsor')	
			    ...
			    $vsql="select fsaldovcr from m_admin where fidmember='$pId' ";		
...
//updateKorwil($fidkorwil, $flevel, $fnama, $fnohp, $falamat, $fprop,fkota $fkec, $femail, $fnoktp, $fket,$db)
 ...
 function updateSeller($fidseller, $fbank, $fnama, $fnohp, $falamat, $fprop,$fkota, $fkec, $femail, $fnoktp,$fnorekening, $fatasnama,$fcountry,$db) {
...
// $vsql="INSERT INTO m_seller (fidseller, fbank, fatasnama, fnama, fnohp, falamat, fkota, fprop, femail, faktif, ftglaktif, fstatusrow, ftglentry, fket, fnoktp, fkec, fnorekening, fcountry) " ;
		    ...
		    $vsql="update m_seller set fbank='$fbank',fnama='$fnama',fnohp='$fnohp',falamat='$falamat',fprop='$fprop',fkota='$fkota',fkec='$fkec',femail='$femail',fnoktp='$fnoktp',fatasnama='$fatasnama', fnorekening='$fnorekening',fcountry='$fcountry'  where fidseller='$fidseller'"; 
 ...
 function updateRef($fidmember,$fnama, $fnohp, $falamat,  $fprop,$fkota, $fkec, $femail, $fnoktp, $fket,$fnorekening,$fatasnama,$fnamabank,$faktif,$fbefore,$fextdate,$db) {
	...
	//REGISTER Seller
	 ...
	 function regSeller($fidseller, $fbank, $fnama, $fnohp, $falamat, $fprop,$fkota, $fkec, $femail, $fnoktp,$fnorekening, $fatasnama,$fcountry,$db) {
