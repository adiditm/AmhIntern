...

{
	...
	{
		global $image_sub_dir;
		if ($image_sub_dir=='')  $image_sub_dir='user';
...
echo '<div style="display:inline" class="col-md-6 col-sm-6 col-xs-4"><input  class="form-control ',$css_class_name,'" type="file" '.$thedir;
			...
			echo '<div style="display:inline" class="col-md-6 col-sm-12 col-xs-4"><input style="min-width:100px !important"  class="form-control ',$css_class_name,'" type="text" '.$thedir;
			...
			if ($this->fdd[$k]['select'] == 'FL' && trim($this->cellDisplay($k, $row, $css_class_name)) != "&nbsp;") 
			   ...
			   $gamb="&nbsp;<IMG border='1' style='max-width:200px'  SRC=\"../images/$image_sub_dir/".$this->cellDisplay($k, $row, $css_class_name)."\">";
...

	{
		...
		if ($this->fdd[$k]['select'] == 'FL' && trim($this->cellDisplay($k, $row, $css_class_name)) != "&nbsp;") 
			...
			else $gamb=$this->cellDisplay($k, $row, $css_class_name);   
